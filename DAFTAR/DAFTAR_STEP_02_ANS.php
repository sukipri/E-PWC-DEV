...
<html>
  ...
  <li class="breadcrumb-item active">Masukan Nomor RM & Tanggal Pesan *(Asuransi</li>
</ol>
	  ...
	  <div class="input-group">
        ...
        <tr>
          ...
          <div class="input-group-addon">Nomor Reg</div> <!-- PL-1806-1001 -->
	 		<input type="text" name="noreg"  class="form-control" readonly value="<?php if($hit_zero > 9999){ echo"PL-$ON$month$hit_zero";}elseif($hit_zero < 9999){ echo"PL-$ON$month$hit_zero";} ?>" required>
	  </div>
	  <br>
		  <div class="input-group">
  			...
  			<button type="button" class="close" data-dismiss="alert">&times;</button>
  				<strong>Maaf!!</strong> Hari & Jam Praktik harus diisi
  					...
  					<strong>Mohon Maaf</strong> Pengindenan harus 1 hari sebelum periksa
						...
						header("location:DAFTAR_STEP_03_ANS.php?IDDKT=$IDDKT&RM=$rm&REG=$noreg"); 
						 echo"OKEEE";
						  }}}
						?>
