...
<html>
  ...
  <li class="breadcrumb-item active">Masukan Nama Dokter *Pribadi</li>
</ol>
	<h4 class="display-3"><a href="#" class="btn btn-info btn-sm disabled">Cari  Dokter </a> &nbsp; <a href="DAFTAR_DOKTER_PRD.php" class="btn btn-warning btn-sm">Daftar Dokter</a></h4>
	<br>
  ...
  <tr>
	...
	<table width="100%"  border="0" class="table table-bordered">
          ...
          <tr>
            ...
            <td><a href="<?php echo"DAFTAR_STEP_02_PRD.php?IDDKT=$vdktt[PelakuKode]#$vdktt[SpesKode]"; ?>" class="btn btn-success"><i class="fa fa-map-marker"></i>&nbsp;Pilih Dokter</a></td>
          </tr>
		  <?php $no++; } ?>
        </table>
		<?php } ?>
