...
?>
                    ...
                    <div class="card border-primary mb-3 mx-2" style="max-width: 60rem;">
                      <div class="card-header"><?PHP echo $baris_kry['nip'] ." - ". $baris_kry['nama'];  ?> - <b>Check In</b></div>
                      <div class="card-body">
                     ...
                     <!-- -->
                        <!-- BUTTON PROCCESING DATA -->
                        	...
                        	<?PHP foreach($data_jdw['data_jdw'] as $baris_jdw){ ?>
                                ...
                                <button type="button" class="btn btn-info btn-lg" onClick="getLocation()"><span class="badge badge-primary"><?PHP echo FS_DATE($DATE_HTML5_SQL) ; ?> </span> Check IN</button>
                                     <p id="demo"></p>
                                    <script>
