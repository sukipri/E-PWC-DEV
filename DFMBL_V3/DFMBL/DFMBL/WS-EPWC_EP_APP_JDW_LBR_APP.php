...
<table class="table table-sm table-bordered table-striped ">
    ...
    <?PHP 
        $open_ctr_plbr_no = 1;
        $open_ctr_vlbr01_sw = $CL_Q("$CL_SL Citarum.dbo.tb_tj_prs_lbr_01 WHERE  plbr_status_01='1'  order by plbr_tglinput_01 desc");
    ...
    <tr>
             ...
             <?PHP 
                  ...
                  ?>
                    ...
                    <?PHP }elseif($open_ctr_vlbr01_sww['plbr_status_01']=="2"){ ?>
                          <span class="badge bg-success">Terkirim (Menunggu Approve Direksi)</span>
                      <?PHP } ?>
        </td>
        ...
        <?PHP 
                    if($open_ctr_vlbr01_sww['plbr_status_01']=="1"){
                  ?>
                 <a href="<?PHP echo"?NAVI=EPWC_MENU_01_EP&PG_SA=WS-EPWC_EP_APP_JDW_LBR_APP&SAVEPLBR01=SAVEPLBR01&IDPLBR01=$open_ctr_vlbr01_sww[idmain_plbr_01]"; ?>" class="btn btn-primary btn-sm">APPROVE</a>
                    <?PHP }elseif($open_ctr_vlbr01_sww['plbr_status_01']=="2"){ ?>
                          <span class="badge bg-success">Terkirim (Menunggu Approve Direksi)</span>
                      <?PHP } ?>
        </td>
    ...
    <?PHP 
        $open_ctr_tot_vlbr01_sw = $CL_Q("$SL SUM(plbr_jmljam_01) as tot_jmljam FROM Citarum.dbo.tb_tj_prs_lbr_01 WHERE plbr_status_01='1'");
