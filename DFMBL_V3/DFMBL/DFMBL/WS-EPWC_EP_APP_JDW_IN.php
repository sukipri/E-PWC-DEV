...
<hr>
	...
	<?PHP 	
		...
		$epwc_vkry01_sw02 = $CL_Q("$SL KaryNomor,KaryNomorYakkum,KaryNama,KaryJbtStruktural,UnitKode FROM TKaryawan WHERE KaryNama LIKE '%$ep_cari_nama_01%'  AND UnitKode='$epwc_vkry01_sww[UnitKode]' ");
			...
			?>
						<div class="alert alert-dismissible alert-secondary">
								...
								<br>
								<a href="<?PHP echo"WS-EPWC_EP_APP_JDW_IN02_MNL.php?&IDEMP02=$epwc_sub_vkry01_sw&IDEMP01=$epwc_sub_vkry01_sw"; ?>" class="badge bg-warning"><i class="far fa-calendar"></i>&nbsp Entri jadwal / Day</a>
								&nbsp
								<!-- 
