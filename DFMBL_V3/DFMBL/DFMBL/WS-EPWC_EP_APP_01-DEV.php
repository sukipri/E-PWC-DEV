...
<body>
	 <div class="container">
		 <h4><a href="http://182.253.60.178/E-PWC/DFMBL_V3/DFMBL/EPWC_HOME_01.php?NAVI=EPWC_MENU_01_EP" class="btn bg-dark btn-warning btn-sm"><i class="fas fa-angle-double-left"></i>BACK</a> Check IN Presensi</h4>
 <?PHP 
...
?>
             ...
             <?php 
					...
					$send02 = curl02("http://182.253.60.178/E-PWC-DEV/BJH12/EP_API/API_EP_TJADWAL_KRY_01.php?IDEMP01=$IDEMP01");
...
?>
 ...
 <?php 
					...
					$sendriv = curlriv("http://182.253.60.178/E-PWC/BJH12/EP_API/API_EP_SAVE_RECINFO_01_VIEW_VALIDASI.php?IDEMP01=$IDEMP01");
