...
<body>
	 <div class="container">
		 <h4><a href="http://103.164.114.138/E-PWC/DFMBL_V3/DFMBL/EPWC_HOME_01.php?NAVI=EPWC_MENU_01_EP" class="btn bg-dark btn-warning btn-sm"><i class="fas fa-angle-double-left"></i>BACK</a> Check IN Presensi</h4>
 <?PHP 
 ...
 */
 ?>
  ...
  //--DATA KARYAWAN--//
					...
					$send = curl("http://103.164.114.138/E-PWC/BJH12/EP_API/API_EP_HR_Personnel.php?IDEMP01=$IDEMP01");
...
?>
             ...
             <?php 
					...
					$send02 = curl02("http://103.164.114.138/E-PWC-DEV/BJH12/EP_API/API_EP_TJADWAL_KRY_01.php?IDEMP01=$IDEMP01");
...
?>
 ...
 <?php 
					...
					$sendriv = curlriv("http://103.164.114.138/E-PWC/BJH12/EP_API/API_EP_SAVE_RECINFO_01_VIEW_VALIDASI.php?IDEMP01=$IDEMP01");
                    ...
                    <div class="card border-primary mb-3 mx-2" style="max-width: 60rem;">
                     ...
                     <!-- VALIDASI -->
                     		<?PHP if($data_riv[0]['status']=="2"){ ?>
                            	<b>Anda Sudah Melakukan Presensi</b>
                            <?PHP }else{ ?>
                     <!-- -->
                        <!-- BUTTON PROCCESING DATA -->
                        	...
                        	<?PHP foreach($data_jdw['data_jdw'] as $baris_jdw){ ?>
								...
								<?PHP 
									#KONVERSI LOGIKA
									if($baris_jdw['tgl']=="C" OR $baris_jdw['tgl']=="D" OR $baris_jdw['tgl']=="E" OR $baris_jdw['tgl']=="W" OR  $baris_jdw['tgl']=="I" OR $baris_jdw['tgl']=="L"  ){
										echo"Maaf Hari ini anda melakukan <i>Cuti/Libur/Dinas Luar/Ijin / Sakit</i>  ?";
										echo"<hr>";
										echo"Jika termasuk salah satu List diatas mohon hubungi Kordinator untuk melakukan perubahan jadwal";
								
									}else{
								?>
                                <button type="button" class="btn btn-info btn-lg" onClick="getLocation()">Check IN</button>
								<?PHP } ?>
                                     <p id="demo"></p>
                                    <script>
									...
									x.innerHTML = "Latitude: " + position.coords.latitude + 
									  ...
									  window.location.href = "?NAVI=EPWC_MENU_01_EP&PG_SA=EPWC_EP_APP_01&IDKRY=<?PHP echo $baris_kry['nip']; ?>&WS-GEOKLIK=WS-GEOKLIK&GEOKLIK=GEOKLIK&IDEMP01=<?PHP echo"$IDEMP01"; ?>&IDLAT01=" + position.coords.latitude + "&IDLONG01=" + position.coords.longitude ; 
                                    }
							</script>     
                              ...
                              <?PHP }  //CLose DATA VALIDASI ?>
								...
								*(<i>Jika Presensi sudah dilakukan tekan back untuk kembali ke halaman utama)
