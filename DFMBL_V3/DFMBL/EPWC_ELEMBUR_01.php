...
<div class="side-navbar active-nav justify-content-between flex-wrap flex-column" id="sidebar">
     <ul class="nav flex-column text-white w-100" style="color:#FFF;">
        ...
        <?PHP  if($epwc_vkry01_sww['KaryNomor']=="04181143" OR $epwc_vkry01_sww['KaryJbtStruktural']=="08" OR $epwc_vkry01_sww['KaryJbtStruktural']=="06" OR  $epwc_vkry01_sww['KaryJbtStruktural']=="07" OR $epwc_vkry01_sww['KaryNomor']=="04181107" OR $epwc_vkry01_sww['KaryNomor']=="04241255"  OR $epwc_vkry01_sww['KaryNomor']=="744/SMG/YAKKUM" ){ ?>
        <li class="nav-link">
