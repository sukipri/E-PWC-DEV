...
<div class="side-navbar active-nav justify-content-between flex-wrap flex-column" id="sidebar">
     <ul class="nav flex-column text-white w-100" style="color:#FFF;">
        ...
        <?PHP  if($epwc_vkry01_sww['KaryNomor']=="04181143" OR $epwc_vkry01_sww['KaryJbtStruktural']=="08" OR $epwc_vkry01_sww['KaryJbtStruktural']=="06" OR  $epwc_vkry01_sww['KaryJbtStruktural']=="07" ){ ?>
        <li class="nav-link">
        ...
        <li class="nav-link">
          <a href="<?PHP echo"?NAVI=EPWC_ELEMBUR_01&PG_SA=EPWC_ELEMBUR_01_VIEW02"; ?>" class="mx-2 h5" style="color:#FFF;"><i class="fas fa-receipt"></i>&nbsp;Approve Lembur</a>
        </li>
        <li class="nav-link">
          <a href="<?PHP echo"?NAVI=EPWC_ELEMBUR_01&PG_SA=EPWC_ELEMBUR_01_VIEW02HIS"; ?>" class="mx-2 h5" style="color:#FFF;"><i class="fas fa-receipt"></i>&nbsp;Riwayat Lem.Personel</a>
        </li>
        <?PHP } ?>
        <?PHP  if($epwc_vkry01_sww['KaryNomor']=="04181143" OR $epwc_vkry01_sww['KaryNomor']=="671/SMG/YAKKUM" OR $epwc_vkry01_sww['KaryNomor']=="04110877" OR $epwc_vkry01_sww['KaryNomor']=="04100869"  ){ ?>
        <li class="nav-link">
