...
<body>
   ...
   <!--
	...
	<br>
		  ...
		  <a href="<?php echo"DAFTAR_STEP_02_PRD.php?IDDKT=$IDDKT&RM=$RM&REG=$REG&BCK=BCK"; ?>" onClick="return konfirmasi()" class="waves-effect waves-light btn red"><i class="material-icons left">arrow_back</i></a>
		  </div>
		  </div>
		</form>
</body>
