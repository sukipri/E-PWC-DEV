    ...
    //error_reporting(0);
		...
		$uu = $ms_fas($u);
			$vkry = $ms_q("$call_sel TKaryawan WHERE KaryNomor='$uu[kode]'");
				$vkryy = $ms_fas($vkry);
        $hit_date = @$sql_slash($_GET['PERIODE']);
		if($uu['akses']==4){ 
		?>
...
<style>
    ...
    <?php
                ...
                echo"<b>Periode Gaji $hit_date</b>";	
                echo"</div>";
        ...
        $num_vgj_skrl = @$nf($vgjj['GajiPotSukarela']);
                ...
                $hit_total = $vgjj['GajiPokokJml'] + $vgjj['GajiKeluargaJml'] +  $vgjj['GajiFungsiJml'] + $vgjj['GajiKhususJml'] + $vgjj['GajiJabatanJml'] + $vgjj['GajiPeralihan'] + $vgjj['GajiTKT'] + $vgjj['GajiKompensasi'] + $vgjj['GajiInsentif'] + $vgjj['GajiLembur'] +  $vgjj['GajiBonus'] + $vgjj['GajiBonusBagian'] + $vgjj['GajiBonusResep'] + $vgjj['GajiMOD'] ;
