...
<body>
<br><br>
    <span style="font-size:20px "><a href="HOME.php"><i class="fas fa-angle-double-left"></i></a> &nbsp;  <a href="?HLM=RIWAYAT_M_RIWAYAT_THR">THR Paskah</a>  &nbsp; THR Natal &nbsp; <a href="?HLM=RIWAYAT_M_RIWAYAT_THR_03"> SHU YAKKUM </a></span>
        <form method="post">
            ...
            <br><br>
             <?php
  			if(isset($_POST['go'])){
						...
						echo"<b>Periode Tahun Natal $tahun</b>";	
						
 				 ?>
  	<?php
		$vthr_sw = $ms_q("$call_sel TGajiTHR WHERE KaryNomor='$vkryy[KaryNomor]' AND GajiTahun='$tahun' AND GajiOtorisasi='4' AND NOT GajiTHRJenis='B' AND GajiTHRJenis='N'  order by GajiTahun desc");
             ...
             <?php } ?>
          	<table width="100%" border="0" class="striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo"<b>Rp.$nom_gaji_total</b>"; ?></td>
                  </tr>
                  <tr>
                    <td>
