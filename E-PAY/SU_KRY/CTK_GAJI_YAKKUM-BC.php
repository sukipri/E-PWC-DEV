...
<option value=""></option>
<?PHP 
        $epwc_sl_vgajiy01_sw = $ms_q("$sl DISTINCT GajiBulan FROM Citarum.dbo.TGajiYakkum WHERE KaryNomorYakkum='$vkryy[KaryNomorYakkum]' AND GajiSTatus='1'");
...
?>
            ...
            <table class="striped">
                ...
                <tr>
                    <td>Tunjangan Kinerja
						...
						<?PHP }elseif($vkryy['KaryNoUrut']=="0002" OR $vkryy['KaryNoUrut']=="0003" OR  ){ ?>
						<li>Resep</li>
						<li>Tunj.Kerja Minimal</li>
						<?PHP } ?>				
					</td>
        ...
        <a href="<?PHP echo"CTK_GAJI_YAKKUM.php?thn=$txt_tahun"; ?>" target="_blank" class="btn">PRINT</a>
		<hr>
		*(lakukan pencetakan document melalui browser , Chrome , Firefox 
