...
<body>
<br><br>
    <span style="font-size:20px "><a href="HOME.php"><i class="fas fa-angle-double-left"></i></a> &nbsp;  THR Paskah  &nbsp; <a href="?HLM=RIWAYAT_M_RIWAYAT_THR_02">THR Natal</a>   &nbsp; <a href="?HLM=RIWAYAT_M_RIWAYAT_THR_03"> SHU </a>  </span>
        <form method="post">
            ...
            <br><br>
             <?php
  			if(isset($_POST['go'])){
						...
						echo"<b>Periode Tahun Paskah $tahun</b>";
						
 				 ?>
                
  	<?php
		$vthr_sw = $ms_q("$call_sel TGajiTHR WHERE KaryNomor='$vkryy[KaryNomor]' AND GajiTahun='$tahun' AND GajiOtorisasi='4' AND NOT GajiTHRJenis='B' AND GajiTHRJenis='P'  order by GajiTahun desc");
