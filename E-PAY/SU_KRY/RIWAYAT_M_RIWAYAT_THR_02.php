...
<body>
<br><br>
    <span style="font-size:20px "><a href="HOME.php"><i class="fas fa-angle-double-left"></i></a> &nbsp;  THR Paskah  &nbsp; <a href="?HLM=RIWAYAT_M_RIWAYAT_THR_02">THR Natal</a>   &nbsp; <a href="?HLM=RIWAYAT_M_RIWAYAT_THR_03"> SHU YAKKUM </a>   </span>
        <form method="post">
