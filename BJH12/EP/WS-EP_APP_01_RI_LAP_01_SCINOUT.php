...
$no_presensi = 1;
     ...
     #RECINFO
            $epwc_vrecinfo01_sw = $ms_q("$call_sel TJ_Main_data.dbo.TA_Record_Info WHERE ep_kode_01 LIKE '%GPS%' AND  Date_Time BETWEEN '$ep_ri_tgl01' AND  '$ep_ri_tgl02 23:59:00' AND  In_Out='1' order by ID desc ");
            $epwc_cn_vrecinfo_sw = $ms_nr($epwc_vrecinfo01_sw);
                while($epwc_vrecinfo01_sww = $ms_fas($epwc_vrecinfo01_sw)){
                        ...
                        #CONVERSION DATA
                          ...
                          #echo"T$epwc_sub_vrecinfo01_sww";
                    ...
                    $epwc_date_d_sw = "T".$epwc_sub_vrecinfo01_sww;
                        ...
                        $item_ri[] = array(
                            ...
                            "cek_shift" =>  $epwc_sub_vrecinfo01_sww04,
                ...
                */
                ?>
           <tr>
                <td><?PHP echo $no_presensi; ?></td>
                <td><?PHP echo $epwc_vrecinfo01_sww['Per_Code']."<br>".$ep_kary01_sww['Per_Name'] ?></td>
                <td> <center>
                <?PHP   if($epwc_vrecinfo01_sww['In_Out']=="1"){  echo $epwc_vshift01_sww['Kode']." -  ". $epwc_vshift01_sww['Masuk']; }elseif($epwc_vrecinfo01_sww['In_Out']=="2"){ $epwc_vshift01_sww['Kode']." -  ". $epwc_vshift01_sww['Keluar'];} ?>    </center></td>
                <td width="20%" ><center><?PHP echo "<span class='badge bg-success'>". $ep_get_vrecinfo01_sww['ambil_waktu']."</span>" ?> </center></td>
                <td>-</td>
                <td>
                    <?PHP 
                     if($jam < 0 ){
