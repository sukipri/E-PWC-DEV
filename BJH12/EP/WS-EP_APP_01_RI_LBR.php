...
?>
    <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <strong class="me-auto">MANUAL PRESENCE > LEMBUR</strong>      
        </div>
        <div class="toast-body">
           MANAGE LEMBUR KARYAWAN
        </div>
    </div>
        <br>
        <form method="post">
    ...
    <?PHP 
        $open_ctr_plbr_no = 1;
        $open_ctr_vlbr01_sw = $ms_q("$call_sel Citarum.dbo.tb_tj_prs_lbr_01 WHERE plbr_status_01='1' AND plbr_tglmasuk_01 BETWEEN '$ep_txt_cari_tg01' AND '$ep_txt_cari_tg02' order by plbr_tglinput_01 desc");
    ...
    <br>
    <a href="<?PHP echo"?HLM=EP_HOME_01&SUB=EP_APP_01&SUB_CHILD=EP_APP_01_MNL&SUB_CHILD02=WS-EP_APP_01_RI_LBR02&GTG01=$ep_txt_cari_tg01&GTG02=$ep_txt_cari_tg02"; ?>" class="btn btn-primary btn-sm">GO >></a>
    <?PHP } ?>
