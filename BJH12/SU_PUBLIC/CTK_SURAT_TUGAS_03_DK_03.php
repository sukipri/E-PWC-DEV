...
<body onLoad="window.print();">
	<div style="padding-top:12rem;"></div>
		<div class="container">
        			<center><font class="fnt_02">SURAT IJIN</font><div class="garis_hori"></div><font class="fnt"><?php echo"No.$vkpp[kop]"; ?></font></center>
                    <br><br><br>
		<div class="fnt">
          ...
          <table width="100%" border="0" class="fnt">
            <tr>
              <td height="55" colspan="2">maka dengan ini kami mengijinkan kepada :</td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="61" colspan="2">  <p>untuk mengikuti acara tersebut di atas.<br>
                    Demikian surat ijin ini dibuat untuk dilaksanakan dengan sebaik-baiknya.</p><br>     </td>
            </tr>
            <tr>
   ...
   <center>dr. Santi Kristiani, Sp.PK <div class="garis_hori_dr"></div> 
           Wadir Penunjang Medis</center>       </td>
