...
<table width="100%" class="table table-bordered" border="0">
	...
	?>
	  ...
	  <tr>
        ...
        <?php 
			$vkry_up = $ms_q("$sl KaryNomor,KaryNama,KaryTglLahir FROM TKaryawan WHERE NOT KaryStatus='91' AND NOT KaryStatus='99'  AND NOT KaryStatus='92'  AND NOT KaryStatus='94'  AND NOT KaryStatus='93' AND UnitKode='$vunn[UnitKode]' AND KaryNomor='$IDKARY' order by  KaryNama asc  "); 
			$no = 1;    
