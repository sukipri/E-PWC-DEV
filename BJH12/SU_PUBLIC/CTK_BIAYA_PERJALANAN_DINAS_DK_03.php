...
<tr>
          ...
          <!--
              ...
              <tr>
                ...
                <?php
				/*
					$vkrp_03 = $ms_q("$sl idmain_kary,jabatan_struk FROM tb_kary_part WHERE idmain_kop='$IDKOP'");
						$no_struk = 1;
              ...
              <tr>
                ...
                <!-- -->
                 <table width="100%" class="table table-bordered">
                  ...
                  <?php 
				  	$vpart02_sw = $ms_q("$call_sel  tb_kary_part WHERE idmain_kop='$IDKOP' order by urut asc");
						$no = 1;
				...
				?>
                    ...
                    <td align="center">
                    	<?php
							$vpr_sw = $ms_q("$sl total_nominal FROM tb_pembiayaan_rekam WHERE idmain_kary='$vpart02_sww[idmain_kary]' AND idmain_kop='$IDKOP' AND idmain_pembiayaan_jenis='265415647190429090810'");
                    ...
                    <td align="center">
                    <?php
							$vpr02_sw = $ms_q("$sl total_nominal FROM tb_pembiayaan_rekam WHERE idmain_kary='$vpart02_sww[idmain_kary]' AND idmain_kop='$IDKOP' AND idmain_pembiayaan_jenis='920415612190429090843'");
                    ...
                    <td align="center">
                       <?php
							$vpr03_sw = $ms_q("$sl total_nominal FROM tb_pembiayaan_rekam WHERE idmain_kary='$vpart02_sww[idmain_kary]' AND idmain_kop='$IDKOP' AND idmain_pembiayaan_jenis='118426834190914124607'");
                    ...
                    <td align="center">
                      <?php
							$vpr04_sw= $ms_q("$sl total_nominal FROM tb_pembiayaan_rekam WHERE idmain_kary='$vpart02_sww[idmain_kary]' AND idmain_kop='$IDKOP' AND idmain_pembiayaan_jenis='-1390810459190914124415'");
                    ...
                    <td align="center">
                      <?php
							$vpr05_sw= $ms_q("$sl total_nominal FROM tb_pembiayaan_rekam WHERE idmain_kary='$vpart02_sww[idmain_kary]' AND idmain_kop='$IDKOP' AND idmain_pembiayaan_jenis='-1343132645190914124405'");
                    ...
                    <td align="center">
                     <?php
							$vpr06_sw= $ms_q("$sl sum(Convert(Integer,total_nominal)) as tot_pem FROM tb_pembiayaan_rekam WHERE idmain_kary='$vpart02_sww[idmain_kary]' AND idmain_kop='$IDKOP' ");
                  ...
                  <?php $no++;} ?>
                   <tr>
                    ...
                    <td align="center">
                      <?php
							$vpr07_sw= $ms_q("$sl sum(Convert(Integer,total_nominal)) as tot_pem FROM tb_pembiayaan_rekam WHERE   idmain_kop='$IDKOP'");
            ...
            <table width="100%" border="0" align="center" class="fnt">
              <tr>
                ...
                an.Direktur
                <br><br><br><br><br><br>
              <center>dr. Santi Kristiani, Sp.PK <div class="garis_hori_dr"></div> 
			  Wadir Keuangan dan Umum</center>  
                ...
                <br><br><br><br><br><br>
                <b>Bayu Setiawan, S.Pd</b><div class="garis_hori_dr"></div>
                Kabag
