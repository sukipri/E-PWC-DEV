...
<div class="collapse navbar-collapse" id="navbarColor02">
    ...
    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="true"><i class="fa fa-suitcase"></i>&nbsp;DATA BANK</a>
    <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 48px, 0px); top: 0px; left: 0px; will-change: transform;">
      ...
      <a class="dropdown-item" href="?HLM=EMP_M"><i class="fa fa-terminal"></i>&nbsp;Data Karyawan</a>
      <a class="dropdown-item" href="?HLM=#"><i class="fa fa-terminal"></i>&nbsp;User QTY Control</a>
      <a class="dropdown-item" href="?HLM=DIV_M"><i class="fa fa-terminal"></i>&nbsp;Departement</a> 
   ...
   <li class="nav-item dropdown show">
    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="true"><i class="fas fa-paste"></i>&nbsp;DATA CONTROL</a>
    <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 48px, 0px); top: 0px; left: 0px; will-change: transform;">
	  <!-- <a class="dropdown-item" href="?HLM=MENU_02"><i class="fa fa-terminal"></i>&nbsp;E-HR Menu</a> -->
      <a class="dropdown-item" href="?HLM=EP_HOME_01"><i class="fa fa-terminal"></i>&nbsp;E-Presence</a>
      <a class="dropdown-item" href="?HLM=SIP_HOME_01"><i class="fa fa-terminal"></i>&nbsp;E-SIP</a>
       <a class="dropdown-item" href="?HLM=KOP_M"><i class="fa fa-terminal"></i>&nbsp;Rapat [E-Meeting]</a>
        <a class="dropdown-item" href="?HLM=FIN_M"><i class="fa fa-terminal"></i>&nbsp;Kompensasi </a>
  ...
  <a href="#" class="btn btn-primary btn-sm"><i class="far fa-envelope"></i>&nbsp;<?php echo"Pesan"; ?></a> &nbsp;
   <a href="?LOGOUT=LOGOUT" class="btn btn-danger btn-sm"><i class="fa fa-sign-out"></i>&nbsp;Log Out</a>
  </div>
</nav>
<?php } ?>