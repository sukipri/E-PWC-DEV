...
$ep_ri_tgl02 = date("tomorrow");
     ...
     #RECINFO
            $epwc_vrecinfo01_sw = $ms_q("$call_sel TA_Record_Info WHERE ep_kode_01 LIKE '%GPS%' AND  Date_Time BETWEEN '$ep_ri_tgl01' AND  '$ep_ri_tgl01 23:59:00' AND  In_Out='2' order by ID desc ");
            $epwc_cn_vrecinfo_sw = $ms_nr($epwc_vrecinfo01_sw);
                while($epwc_vrecinfo01_sww = $ms_fas($epwc_vrecinfo01_sw)){
                    ...
                    $epwc_date_d_sw = "T".$epwc_sub_vrecinfo01_sww;
                        ...
                        #DATA Shift Get
                        /* */
                        $epwc_vshift01_sw = $ms_q("$call_sel tShif WHERE Kode='$epwc_sub_vrecinfo01_sww04'");
