...
$ep_ri_tgl02 = date("tomorrow");
     ...
     #RECINFO
            $epwc_vrecinfo01_sw = $ms_q("$call_sel TA_Record_Info WHERE ep_kode_01 LIKE '%GPS%' AND  Date_Time BETWEEN '$ep_ri_tgl01' AND  '$ep_ri_tgl01 23:59:00' AND  In_Out='1' order by ID desc ");
