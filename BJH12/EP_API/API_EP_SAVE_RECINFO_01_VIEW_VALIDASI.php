...
$RAND_DATA = rand('88','99');
    ...
    //--GET DATA
        ...
        //--RECINFO DATA--//
            $epwc_vrecinfo01_sw = $ms_q("$call_sel TJ_Main_Data.dbo.TA_Record_Info WHERE Per_Code='$IDEMP01' AND (Date_Time BETWEEN '$date_html5  00:00:00' AND '$date_html5  23:59:00' ) AND  ($epwc_shift_sw) AND In_Out='1'  order by Date_Time desc ");
