...
$IDEMPUNIT01 = @$_GET['IDEMPUNIT01'];

        //--RECINFO DATA--//
            $epwc_vrecinfo01_sw = $ms_q("$sl TOP 4 * FROM  TA_Record_Info WHERE Per_Code='$IDEMPUNIT01' AND ep_kode_01 LIKE '%GPS%' order by Date_Time desc ");
            $epwc_cn_vrecinfo_sw = $ms_nr($epwc_vrecinfo01_sw);
                while($epwc_vrecinfo01_sww = $ms_fas($epwc_vrecinfo01_sw)){
                          ...
                          $epwc_sub_vrecinfo01_sww03 = substr($epwc_vrecinfo01_sww['Date_Time'],0,-9); //> Ambil Jam
                    ...
                    $epwc_date_d_sw = "T".$epwc_sub_vrecinfo01_sww;
                        ...
                        $item_ri[] = array(
                            ...
                            "tgl_get"=> $epwc_sub_vrecinfo01_sww02,
