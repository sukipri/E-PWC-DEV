...
if(isset($_GET['WS-GEOKLIK'])){
          ...
          //--Proccesing--//  
            $epwc_save_recinfo_01 = $ms_q("$in TA_Record_Info(Mach_Name,Per_ID,Per_Code,Per_Finger,Date_Time,In_Out,ep_kode_01,ep_lat_01,ep_long_01,ep_tjd_bulan_01,ep_tjd_hari_01,ep_tjd_shift_01)VALUES('1','$IDKRY','$IDEMP01','0','$date_html5  $date_time','1','GPS-$date_html5_kode-$time_ack2','$IDLAT01','$IDLONG01','$epwc_tjdw01_sww[Bulan]','T$SETUP_DATE_D','$epwc_tjdw01_sww[$epwc_date_d_sw]')");
