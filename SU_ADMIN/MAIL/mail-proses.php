...
$message = "<img src=http://daftar.pantiwilasa-citarum.co.id/images/head2_new.jpg width=1000 height=200> <br>Pendaftaran anda telah disetujui, <br>Nomor urut anda <br><font size=14><b>$NO</b></font><br>Nomor RM //$RM<br>Nomor Reg //$REG<br>Email $EML<br>Datang tanggal $TG <br> $HARI $WAKTU <br> <a href=http://daftar.pantiwilasa-citarum.co.id/E-PWC/DAFTAR/DAFTAR_PRINT.php?IDDKT=$IDDKT&REG=$REG&RM=$RM>Klik, Untuk Cetak bukti Pendaftaran (Gunakan Personal Komputer/PC)</a>";
