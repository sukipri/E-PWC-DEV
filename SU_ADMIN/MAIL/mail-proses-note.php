...
error_reporting(E_ALL & ~E_DEPRECATED & ~E_NOTICE);
	...
	require "phpmailer/PHPMailerAutoload.php";
	 ...
	 include"../config/connec_01_srv.php";
			...
			$EML = @$_GET['EML'];
			$REG = @$_GET['REG'];
		$vrj_01 =  mssql_query("select * from TRawatJalan  where JalanNoReg='$REG'");
				$vrjj_01 = mssql_fetch_assoc($vrj_01);
			$ket = "Berkas anda Photo / Gambar tidak Jelas mohon Segera Dilengkapi";
			$ket02 = "<a href=http://daftar.pantiwilasa-citarum.co.id/E-PWC/DFMBL_V2/UPLOAD_BERKAS.php?RM=$RM&REG=$REG&KDREG=$REG>Klik Disi</a>";

$message = "<img src=http://daftar.pantiwilasa-citarum.co.id/images/head2_new.jpg width=1000 height=200><br>$ket<br>$ket02<br>$vrjj_01[PasienGeder]";
...
try {
	...
	echo"<h4>Pesan berhasil Dikirim<br>$vrjj_01[PasienGeder]</h4>";
?>
