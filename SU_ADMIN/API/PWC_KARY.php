    ...
    header("Access-Control-Allow-Headers: Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With");
        ...
        $vkary_sw = $ms_q("$call_sel TKaryawan WHERE NOT KaryStatus='91' AND NOT KaryStatus='92' AND NOT  KaryStatus='94' AND NOT KaryStatus='99' order by KaryNama asc "); 
            ...
            while($vkary_sww = $ms_fas($vkary_sw)){
                #DATA TGL LAHIR
                $vkary_tg_sw = $ms_q("$sl convert(varchar,KaryTglLahir, 23) as tg_23 FROM TKaryawan WHERE KaryNomorYakkum='$vkary_sww[KaryNomorYakkum]'");
                $vkary_tg_sww = $ms_fas($vkary_tg_sw);
                $data_kary[] = array(
                    ...
                    "tanggallahir"=>$vkary_tg_sww['tg_23']
