...
<body>
  ...
  <li class="breadcrumb-item"><a href="?HLM=DATA_PASIEN_LAB_CARI">Cari Hasil Lab</a></li>
</ol>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
      ...
      <table width="100%" border="0" class="table table-bordered">
		...
		<?php
			$vlb = $ms_q("$sl  LabNomor,LabTanggal,PasienNomorRM,DokterKode from TLab WHERE LabTanggal BETWEEN '$tg1' AND '$tg2' order by LabTanggal desc");
			$no = 1;
