<b>#REKAP KODE REGISTER * NomorRM</b>
<hr>
<form method="post">
<div class="input-group input-group-sm mb-3" style="max-width:21rem;">
<span class="badge bg-info">Nomor RM</span>
  <input type="text" class="form-control form-control-sm" required name="norm">
...
<?PHP 
    #DATA KODE RESGISTER
    $pwc_vkr01_sw = $ms_q("$call_sel tb_vk_kr_01 WHERE PasienNomorRM='$norm' ");
