...
<form name="form1" method="post" action="">
  <table width="100%" border="0" class="table table-bordered">
    ...
    <tr>
      <td width="34%"><input type="text" name="jam" class="form-control" required placeholder="Jam Mulai"></td>
      <td width="20%"><input type="text" name="jam2" class="form-control" required placeholder="Jam Selesai"></td>
    </tr>
    <tr>
