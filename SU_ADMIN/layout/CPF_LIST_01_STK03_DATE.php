  ...
  <div class="row">
      <?PHP 
        $pwc_vcpf01_sw = $ms_q("$sl DISTINCT form_jenis_01 FROM tb_cpf_form_01 order by form_jenis_01 ");
            ...
            $pwc_nr_vcpf01_sw = $ms_q ("$sl form_jenis_01 FROM tb_cpf_form_01 WHERE form_jenis_01='$pwc_vcpf01_sww[form_jenis_01]' AND (form_tglinput_01 BETWEEN '$tg01' AND '$tg02')   ");
