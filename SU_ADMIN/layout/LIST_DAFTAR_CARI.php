	...
	$vps = @$ms_q("SELECT *  FROM TRawatJalan where JalanNoReg='$nama' OR PasienNomorRM='$nama' order by TanggalPesan desc");
          ...
          <tr>
			...
			<?php
				...
				<a href="<?php echo"?HLM=LIST_DETAIL_DAFTAR&IDDKT=$vpss[DokterKode]&RM=$vpss[PasienNomorRM]&WAKTU=$vpss[WaktuPesan]&REG=$vpss[JalanNoReg]&NORJK=$no_rjk&LENGKAP=LENGKAP#LENGKAP"; ?>" class="btn btn-warning btn-sm">Butuh Persetujuan</a>
				<?php } ?>
			</td>
