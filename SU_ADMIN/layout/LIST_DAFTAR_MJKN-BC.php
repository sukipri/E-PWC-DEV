  ...
  <tr>
    ...
    <td>&nbsp;</td>
        ...
        <table width="100%" border="0" class="table table-bordered">
            ...
            <td width="19%">Poli</td>
		  	...
		  	<?php
				if(isset($_POST['cari'])){
					$tg1 = @$_POST['tg1'];
					$tg2 = @$_POST['tg2'];
				$vps = @$ms_q("SELECT  * FROM TRawatJalan where TanggalPesan BETWEEN '$tg1' AND '$tg2 23:59:00' AND JalanCaraDaftar='4' AND JalanNoReg LIKE '%PL-WS%' AND NOT JalanStatus='9' AND NOT JalanNoUrut='00'   ORDER BY JalanRMTanggal DESC");
					$no = 1;
						
					while($vpss = $ms_fas($vps)){
                        #DATA DOKTER
                        $pwc_vdkt01_sw = $ms_q("$sl PelakuKode,PelakuNama,PelakuBPJSKode,SpesKodeBPJS FROM TPelaku WHERE PelakuKode='$vpss[DokterKode]'");
          ...
          <tr>
            ...
            <td align="center"> <?php
			 ...
			 ?>
               ...
               <?php }else{ ?>
			   	<b><font color="#006633">MJKN</font></b>
			<?php } ?></td>
             <td>
			 <?php echo"$vpll[UnitNama]"; ?>
             <br>
             <?PHP echo $pwc_vdkt01_sww['PelakuNama'];?>
		  ...
		  <?php $no++; }  ?>
		  <?php
		  	$vps_02 = @$ms_q("SELECT  * FROM TRawatJalan where TanggalPesan BETWEEN '$tg1' AND '$tg2 23:59:00' AND JalanCaraDaftar='4'  AND JalanNoReg LIKE '%PL-WS%' AND NOT JalanStatus='9' AND NOT JalanNoUrut='00'");
				$vps_02_jum = $ms_nr($vps_02);
			$vps_03 = @$ms_q("SELECT  * FROM TRawatJalan where TanggalPesan BETWEEN '$tg1' AND '$tg2 23:59:00' AND JalanCaraDaftar='4' AND JalanNoReg LIKE '%PL-WS%' AND NOT JalanStatus='9' AND NOT JalanNoUrut='00'   ORDER BY JalanRMTanggal DESC");
		   ...
		   ?>
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><?php echo"Selesai <b>$vps_02_jum</b>"; ?></td>
            <td><?php echo"Menunggu <b>$vps_03_jum</b>"; ?></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
		  <?php } ?>
