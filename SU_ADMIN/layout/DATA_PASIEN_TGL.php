	...
	<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="?HLM=DATA_PASIEN"><i class="fa fa-circle-o-notch"></i>&nbsp;Data Pasien *Name</a></li>
    <li class="breadcrumb-item"> Data Pasien *Daftar</li>
  </ol>
  
      <form name="form1" method="post" action="">
        <table class="table" border="0" style="max-width:30rem;">
          <tr>
              <!--
            <td width="253"><input type="date" name="tg01" class="form-control form-control-sm" required></td>
            <td width="253"><input type="date" name="tg02" class="form-control form-control-sm" required></td>
              -->
              <td>
                  <select name="tg01_bulan" class="form-control form-control-sm" required>
                  <option value="">ENTRIKAN BULAN</option>
                  <?PHP 
                      $tg_no = 1;
                      
                      while($tg_no <= 12){
                      $tg_zero = sprintf("%02d", $tg_no);
                      echo"<option value=$tg_zero>$tg_zero</option>";
                      $tg_no++; }
                  ?>
                  </select>
              </td>
              <td>
                  <select name="tg01_tahun" class="form-control form-control-sm" required>
                  <option value="">ENTRIKAN TAHUN</option>
                  <?PHP 
                      $tg_no02 = 2020;
                      
                      while($tg_no02 <= 2030){
                      $tg_zero02 = sprintf("%02d", $tg_no02);
                      echo"<option value=$tg_zero02>$tg_zero02</option>";
                      $tg_no02++; }
                  ?>
                  </select>
              </td>
            <td width="156"><button name="cari" class="btn btn-success btn-sm">Cari Pasien</button></td>
          </tr>
        </table>
      </form>
      <?PHP 
      if(isset($_POST['cari'])){
          $tg01_bulan = @$_POST['tg01_bulan'];
          $tg01_tahun = @$_POST['tg01_tahun'];
           $tg01 = "$tg01_tahun-$tg01_bulan-01";
           $tg02 = "$tg01_tahun-$tg01_bulan-30";
              echo"<i>SORTING ".tanggal_indo($tg01)." - ".tanggal_indo($tg02)."</i>";
      ?>
      ...
      $pwc_pasien_no = 1;
        ...
        ?>
          ...
          <td colspan="8">-</td>
              ...
              <a href="<?PHP echo"layout/DATA_PASIEN_TGL_REDI_XLS.php?tg01_bulan=$tg01&tg01_tahun=$tg02"; ?>" target="_blank" class="btn btn-success btn-sm">DOWNLOAD DATA</a>
              <br>
              <table class="table table-sm">
              <tr>
                  <td width="17%">
                      <span class="badge bg-dark">TOTAL PASIEN</span>
                      <!--  -->
                      <ul class="list-group" style="max-width:20rem;">
                          <li class="list-group-item d-flex justify-content-between align-items-center">
                          Total Pasien
                              <span class="badge bg-primary rounded-pill"><?PHP echo @$nf($jum_vps);  ?></span>
                          </li>
                    </ul>
                  </td>
                  <td>
                  <span class="badge bg-dark">PENDIDIKAN</span>
                       ...
                       <ul class="list-group" style="max-width:20rem;">
                          ...
                          <span class="badge bg-primary rounded-pill"><?PHP echo @$nf($vpss_nr_pdk);  ?></span>
                          </li>
