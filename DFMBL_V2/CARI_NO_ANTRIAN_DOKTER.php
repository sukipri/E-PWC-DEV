        ...
        <tbody>
          ...
          <tr class="txt">
            <td colspan="3"><?php echo"$vdktt[PelakuNama]<br> <b>Poli $txt_01</b>"; ?>
			 <center><a href="<?php echo"CARI_NO_ANTRIAN.php?IDDKT=$vdktt[PelakuKode]#$vdktt[SpesKode]"; ?>" class="waves-effect waves-light btn green"><i class="material-icons left">done</i>&nbsp;Pilih Dokter</a></center></td>
          </tr>
        <?php } ?>
        </tbody>
      </table>
