...
<body>
	...
	<form method="post">
     ...
     <button name="simpan" class="waves-effect waves-light btn"><i class="material-icons left">save</i>Simpan</button>
	  <a href="<?php echo"CARI_DOKTER_ANS.php?IDDKT=$vdktt[PelakuKode]#$vdktt[SpesKode]"; ?>"class="waves-effect waves-light blue btn"><i class="material-icons">arrow_back</i></a>
</form>  
