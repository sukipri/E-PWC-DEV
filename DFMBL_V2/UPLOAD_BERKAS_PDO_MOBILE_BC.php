...
<body>
	...
	<form method="post" enctype="multipart/form-data">
	   ...
	   <label for="email">No pendaftaran</label>
		...
		<input type="file" name="up"   accept="image/jpeg" disabled>
           ...
           <tr class="txt">
			 ...
			 <tr class="txt">
              <th>
			    <label><font color="#990000">*Unggah Surat Kontrol /  Kronologi</font></label>
	   ...
	   <table class="table striped">
	   <?php
						$vgbr_02 =  $ms_q("$sl idmain_gambar,JalanNoReg,gambar,GambarStatus from TBGambar where JalanNoReg='$KDREG02' order by GambarStatus asc");
