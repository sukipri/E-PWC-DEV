...
<body>
    ...
    <div class="nav-wrapper blue accent-2">
	   <ul>
      <li><a href="#!!">Pendaftaran Online (BPJS)</a></li>
      </ul>
	  </div>
  </nav>
  <!--
	 ...
	 -->
	     <div class="pdt txt">
		<a href="CARI_DOKTER.php" class="waves-effect waves-light btn grey"><i class="material-icons">chevron_left</i></a>
        ...
        <tbody>
          ...
          <tr class="txt">
            <td colspan="3"><?php echo"$vdktt[PelakuNama]<br> <b>Poli $txt_01</b>"; ?>
			 <center><a href="<?php echo"DAFTAR_STEP_02.php?IDDKT=$vdktt[PelakuKode]#$vdktt[SpesKode]"; ?>" class="waves-effect waves-light btn green"><i class="material-icons left">done</i>&nbsp;Pilih Dokter</a></center></td>
          </tr>
        <?php } ?>
        </tbody>
      </table>
