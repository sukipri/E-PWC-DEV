...
$message = "<img src=http://daftar.pantiwilasa-citarum.co.id/images/logo_citarum.png><h4>Maaf,Pendaftaran anda ditolak, Silahkan cek di  '<i>Cek Status Pendaftaran</i>' untuk lebih detailnya </h4> ";
