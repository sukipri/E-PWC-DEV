...
<!--  -->
    ...
    <tr>
        ...
        <td></td>
        <td>
            <a href="<?PHP echo"?PG_SA=CPF01_MD_KEG03_01&PG_SA_SUB=CPF01_MD_KEG03_01_IN03REC02&IDKEG03=$cpf_vkeg03_sww[idmain_keg_03]"; ?>" class="btn btn-danger btn-sm"><i class="fas fa-arrow-alt-circle-right"></i> Pilih Kasus</a>
            &nbsp
