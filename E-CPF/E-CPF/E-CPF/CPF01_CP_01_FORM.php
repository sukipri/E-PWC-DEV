...
<?PHP $cpf_cp_no++; } 
    ...
    $cpf_sum_vformh01_sw = $CL_Q("$SL SUM(head_tot_01) as tot_persen FROM Citarum.dbo.tb_cpf01_form_01_head WHERE idmain_inap_01='$IDADM01'");
...
<?PHP 
    ...
    echo"&nbsp";
    echo"<button class='btn btn-dark' name='cp_upload_01'><i class='fas fa-calculator'></i> 2.KALKULASI DENOM</button>";
    echo"&nbsp";
