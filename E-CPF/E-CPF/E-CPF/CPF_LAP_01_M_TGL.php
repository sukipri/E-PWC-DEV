	...
	<body>
    		<b>#DATA CPF *All</b>	
				...
				<div class="input-group input-group-sm mb-3" style="max-width:30rem;">
                      <input type="date" name="cpf_tgl_01" class="form-control form-control-sm" required>
                        <input type="date" name="cpf_tgl_02" class="form-control form-control" required>
                     <button name="cpf_btn_tgl_01" class="btn btn-info btn-sm">CARI DATA</button>
				</div>
                </form>
                <!-- -->
                <?PHP 
					if(isset($_POST['cpf_btn_tgl_01'])){
				...
				<table width="100%" class="table table-sm table-bordered table-striped" style="max-width:60rem" border="0">
                      ...
                      <?PHP 
					  		$cpf_form_no_01 = 1;
						$cpf_vcpf01_swds = $CL_Q("$SL DISTINCT form_jenis_01 FROM tb_cpf_form_01 WHERE form_uploader='$vus01_sww[idmain]' ");
								while($cpf_vcpf01_swwds = $CL_FAS($cpf_vcpf01_swds)){
									
					  		$cpf_vcpf01_sw = $CL_Q("$CL_SL  tb_cpf_form_01 WHERE form_jenis_01='$cpf_vcpf01_swwds[form_jenis_01]' AND (form_tglinput_01 BETWEEN '$cpf_tgl_01' AND '$cpf_tgl_02') AND form_uploader='$vus01_sww[idmain]' ");
                      ...
                      <tr>
                        ...
                        <td><?PHP echo"$cpf_num_div_vcpf01_sw"; ?></td>
                        <td>&nbsp;</td>
                      </tr>
