...
<?PHP 
    $cpf_vkeg03rec_sw = $CL_Q("$CL_SL Citarum.dbo.tb_cpf01_keg02_03_rec WHERE idmain_keg_03='$cpf_vw_vkeg0203_sww[idmain_keg_03]' AND idmain_keg_01='$cpf_vkeg01_sww[idmain_keg_01]'");
     while($cpf_vkeg03rec_sww = $CL_FA($cpf_vkeg03rec_sw)){
        $cpf_vkeg02_sw = $CL_Q("$SL idmain_keg_02,idmain_keg_01,keg_nama_02,keg_ket_02,keg_status_02 FROM Citarum.dbo.tb_cpf01_keg02_02 WHERE idmain_keg_02='$cpf_vkeg03rec_sww[idmain_keg_02]'");
...
<tr>
    ...
    <td>
        <a href="<?PHP echo"?PG_SA=CPF01_MD_KEG02_01&PG_SA_SUB=CPF01_MD_KEG02_01_FORM_RWT&IDKEG03=$IDKEG03&IDKEG03REC=$cpf_vkeg03rec_sww[idmain_keg_03_rec]&UPKEG0203REC=UPKEG0203REC"; ?>" class="btn btn-outline-warning btn-sm">Add Value</a>
    </td>
</tr>
<?PHP } ?>
</table>
