...
<div class="input-group mb-3" style="max-width:45rem;">
  ...
  <input type="date" class="form-control form-control-sm" required name="tg02" value="<?PHP echo $DATE_HTML5_SQL ?>" required>
    ...
    <?PHP 
        $cpf_vkeg03_sw = $CL_Q("$SL idmain_keg_03,keg_nama_03 FROM Citarum.dbo.tb_cpf01_keg02_03 ");
...
<?PHP 
    ...
    $tg02 = @$_POST['tg02'];
    $list01 = @$_POST['list01'];
    $cpf_vkeg03_sw02 = $CL_Q("$SL idmain_keg_03,keg_nama_03 FROM Citarum.dbo.tb_cpf01_keg02_03 WHERE idmain_keg_03='$list01' ");
...
<div class="card border-primary mb-3" style="max-width: 35rem;">
  ...
  <div class="card-body">
   ...
   <?PHP 
    #KALKULASI 
    $cpf_disnr_vfhead01_sw = $CL_Q("$SL DISTINCT idmain_inap_01 FROM Citarum.dbo.tb_cpf01_form02_01_head WHERE head_tglinput_01 BETWEEN '$tg01' AND '$tg02 23:59:00' AND idmain_keg_03='$list01'");
    $cpf_disnr_vfhead01_sww = $CL_NR($cpf_disnr_vfhead01_sw); #DATA DIS INAP
    $cpf_totcp_vfhead01_sw = $CL_Q("$SL SUM(head_tot_01) as tot_cp FROM Citarum.dbo.tb_cpf01_form02_01_head WHERE head_tglinput_01 BETWEEN '$tg01' AND '$tg02 23:59:00' AND idmain_keg_03='$list01' ");
...
?>
    <h4>
        <?PHP 
            ...
            echo"<br>";
            #DATA KAL FORM HEAD
        $cpf_lskal_vfhead01_sw = $CL_Q("$SL DISTINCT idmain_keg_01  FROM Citarum.dbo.tb_cpf01_form02_01_head WHERE head_tglinput_01 BETWEEN '$tg01' AND '$tg02 23:59:00' AND idmain_keg_03='$list01' ");
        while($cpf_lskal_vfhead01_sww = $CL_FAS($cpf_lskal_vfhead01_sw)){
            #DATA KEG01
            $cpf_lskal_vkeg01_sw = $CL_Q("$SL idmain_keg_01,keg_nama_01 FROM Citarum.dbo.tb_cpf01_keg02_01 WHERE idmain_keg_01='$cpf_lskal_vfhead01_sww[idmain_keg_01]' order by keg_urut_01 asc");
            $cpf_lskal_vkeg01_sww = $CL_FAS($cpf_lskal_vkeg01_sw);
        #DATA SUM
        $cpf_sum_vfhead01_sw = $CL_Q("$SL SUM(head_tot_01) as sum_tot01 FROM Citarum.dbo.tb_cpf01_form02_01_head WHERE idmain_keg_01='$cpf_lskal_vfhead01_sww[idmain_keg_01]' AND head_tglinput_01 BETWEEN '$tg01' AND '$tg02 23:59:00' AND idmain_keg_03='$list01'  ");
...
<table class="table table-sm table-striped table-bordered">
    ...
    <?php
     #KALKULASI
     $cpf_data_vfhead01_sw = $CL_Q(" $SL DISTINCT  idmain_inap_01 FROM  Citarum.dbo.tb_cpf01_form02_01_head WHERE head_tglinput_01 BETWEEN '$tg01' AND '$tg02 23:59:00' AND idmain_keg_03='$list01' ");
     while($cpf_data_vfhead01_sww = $CL_FAS($cpf_data_vfhead01_sw)){
        #UPLOADER CPF HEAD
        $cpf_upl_vfhead01_sw = $CL_Q("$SL idmain_cpf01_form_01_head,uploader FROM Citarum.dbo.tb_cpf01_form02_01_head WHERE idmain_inap_01='$cpf_data_vfhead01_sww[idmain_inap_01]'");
    ...
    <tr>
        ...
        <td>
            <!-- - -->
            <?PHP 
                   $cpf_ls_vkeg01_sw = $CL_Q("$SL idmain_keg_01 FROM Citarum.dbo.tb_cpf01_form02_01_head WHERE idmain_inap_01='$cpf_data_vfhead01_sww[idmain_inap_01]'");
                    while($cpf_ls_vkeg01_sww = $CL_FAS($cpf_ls_vkeg01_sw)){ #DATA KEG
                    #KEG 01
                    $cpf_ls02_vkeg01_sw = $CL_Q("$SL idmain_keg_01,keg_nama_01 FROM Citarum.dbo.tb_cpf01_keg02_01 WHERE idmain_keg_01='$cpf_ls_vkeg01_sww[idmain_keg_01]' order by keg_urut_01 asc");  
                     $cpf_ls02_vkeg01_sww = $CL_FAS($cpf_ls02_vkeg01_sw);

                $cpf_ls_vfhead01_sw = $CL_Q(" $SL idmain_cpf01_form_01_head,idmain_inap_01,head_kode_01,head_tot_01,head_tot02_02,head_tglinput_01,head_status_01,idmain_keg_03,idmain_keg_01,uploader FROM  Citarum.dbo.tb_cpf01_form02_01_head WHERE head_tglinput_01 BETWEEN '$tg01' AND '$tg02 23:59:00' AND idmain_keg_03='$list01' AND idmain_inap_01='$cpf_data_vfhead01_sww[idmain_inap_01]' AND idmain_keg_01='$cpf_ls_vkeg01_sww[idmain_keg_01]' ");
                    $cpf_ls_vfhead01_sww = $CL_FAS($cpf_ls_vfhead01_sw);

                        echo"<i class='fas fa-file-medical'></i>  $cpf_ls02_vkeg01_sww[keg_nama_01] ";
                        echo "<span class='display-5'><b>".$cpf_ls_vfhead01_sww['head_tot_01']."%</b> </span>";
                        echo"<br>";
                    }
