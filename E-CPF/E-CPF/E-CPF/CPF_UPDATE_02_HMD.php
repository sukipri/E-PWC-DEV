...
<?PHP
	...
	$cpf_vinap01_sw = $CL_Q("$SL InapNoAdmisi,PasienNomorRM,InapTglMasuk,InapTglKeluar FROM TRawatInap WHERE InapNoAdmisi='$IDADM01'");
        ...
        include"E-CPF/CPF_ENTRI_02_HMD_HIT.php"; #HIT MARK CALCULATE
...
<table width="100%" class="table table-bordered table-sm" style="max-width:40rem;" border="0">
          <tr>
            ...
            <div class="input-group mb-3">
               ...
               ?>
                <option value="APN" selected>APN</optiosn>
               <?PHP 
                  }elseif($cpf_vcform01_sww['form_jenis_01']=="HMD"){
               ?>
               ...
               ?>
                <option value="STT" selected>STT</optiosn>
                <?PHP 
                  }elseif($cpf_vcform01_sww['form_jenis_01']=="HRN"){
               ?>
                <option value="HRN" selected>HRN</optiosn>
                  <?PHP }else{ ?>
              ...
              <input style="max-width:15rem;" type="text" name="form_nama_01" class="form-control form-control-sm" placeholder="keterangan Form.." required autocomplete="off" value="<?PHP echo $cpf_vcform01_sww['form_nama_01']; ?>">
      </div>
                  <br>
                  <span class="bg-info">YY/MM/DD</span>
                  <input type="text" style="max-width:10rem;" name="form_tglinput_01" class="form-control form-control-sm" value="<?PHP echo $cpf_vcform01_sww['form_tglinput_01'];  ?>">
      ...
      <tr>
        ...
        <table width="100%" class="table table-bordered table-sm" border="0">
            ...
            <tr>
                ...
                <?PHP echo "<span class='badge bg-warning'>".$cpf_as02_vform01_sw."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>
              ...
              <tr>
                ...
                <td>-</td>
                <td colspan="3">
                  <?PHP echo "<span class='badge bg-warning'>".$cpf_rad02_vform01_sw."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>		
              ...
              <tr>
         	   ...
         	   <td colspan="3">
                    ...
                    <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Day 1</span>
                          </div>
                       <select name="form_as02_pj02_01" class="form-control form-control-sm">
                            <?PHP 
                                $cpf_form_no_pj02 = 0;
                                while($cpf_form_no_pj02<= 3){
                                    if($cpf_vcform01_sww['form_as02_pj02_01']==$cpf_form_no_pj02){
                                    echo"<option value=$cpf_form_no_pj02 selected>$cpf_form_no_pj02</option>";	
                                    }else{
                                    echo"<option value=$cpf_form_no_pj02>$cpf_form_no_pj02</option>";	
                                    }
                                $cpf_form_no_pj02++; } 
                    ...
                    <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Day 2</span>
                          </div>
                       <select name="form_as02_pj03_01" class="form-control form-control-sm">
                           
                            <?PHP 
                                $cpf_form_no_pj03 = 0;
                                while($cpf_form_no_pj03<= 3){
                                    if($cpf_vcform01_sww['form_as02_pj03_01']==$cpf_form_no_pj03){
                                    echo"<option value=$cpf_form_no_pj03 selected>$cpf_form_no_pj03</option>";	
                                    }else{
                                    echo"<option value=$cpf_form_no_pj03>$cpf_form_no_pj03</option>";	
                                    }
                                $cpf_form_no_pj03++; } 
                    ...
                    <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Day 3</span>
                          </div>
                       <select name="form_as02_pj04_01" class="form-control form-control-sm">
                           
                            <?PHP 
                                $cpf_form_no_pj04 = 0;
                                while($cpf_form_no_pj04<= 3){
                                    if($cpf_vcform01_sww['form_as02_pj04_01']==$cpf_form_no_pj04){
                                    echo"<option value=$cpf_form_no_pj04 selected>$cpf_form_no_pj04</option>";	
                                    }else{
                                    echo"<option value=$cpf_form_no_pj04>$cpf_form_no_pj04</option>";	
                                    }
                                $cpf_form_no_pj04++; } 
             ...
             <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Day 4</span>
                          </div>
                       <select name="form_as02_pj05_01" class="form-control form-control-sm">
                           
                            <?PHP 
                                $cpf_form_no_pj05 = 0;
                                while($cpf_form_no_pj05<= 4){
                                    if($cpf_vcform01_sww['form_as02_pj05_01']==$cpf_form_no_pj05){
                                    echo"<option value=$cpf_form_no_pj05 selected>$cpf_form_no_pj05</option>";	
                                    }else{
                                    echo"<option value=$cpf_form_no_pj05>$cpf_form_no_pj05</option>";	
                                    }
                                $cpf_form_no_pj05++; } 
              ...
              <tr>
                ...
                <td>-</td>
                <td colspan="3">                  
                <?PHP echo "<span class='badge bg-warning'>".$cpf_al02_vform01_sw."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>		
              ...
              <tr>
                ...
                <div class="input-group mb-3">
                          ...
                          <select name="form_as02_reresep02_01" class="form-control form-control-sm">
                      <?PHP 
                            $cpf_form_no_reresep02 = 0;
                            while($cpf_form_no_reresep02<= 3){
                              if($cpf_vcform01_sww['form_as02_reresep02_01']==$cpf_form_no_reresep02){
                              echo"<option value=$cpf_form_no_reresep02 selected>$cpf_form_no_reresep02</option>";	
                              }else{
                              echo"<option value=$cpf_form_no_reresep02>$cpf_form_no_reresep02</option>";	
                              }
                            $cpf_form_no_reresep02++; } 
                    ...
                    <div class="input-group mb-3">
                          ...
                          <select name="form_as02_reresep03_01" class="form-control form-control-sm">
                      <?PHP 
                            $cpf_form_no_reresep03 = 0;
                            while($cpf_form_no_reresep03<= 3){
                              if($cpf_vcform01_sww['form_as02_reresep03_01']==$cpf_form_no_reresep03){
                              echo"<option value=$cpf_form_no_reresep03 selected>$cpf_form_no_reresep03</option>";	
                              }else{
                              echo"<option value=$cpf_form_no_reresep03>$cpf_form_no_reresep03</option>";	
                              }
                            $cpf_form_no_reresep03++; } 
                    ...
                    <div class="input-group mb-3">
                          ...
                          <select name="form_as02_reresep04_01" class="form-control form-control-sm">
                      <?PHP 
                            $cpf_form_no_reresep04 = 0;
                            while($cpf_form_no_reresep04<= 3){
                              if($cpf_vcform01_sww['form_as02_reresep04_01']==$cpf_form_no_reresep04){
                              echo"<option value=$cpf_form_no_reresep04 selected>$cpf_form_no_reresep04</option>";	
                              }else{
                              echo"<option value=$cpf_form_no_reresep04>$cpf_form_no_reresep04</option>";	
                              }
                            $cpf_form_no_reresep04++; } 
                   ...
                   <div class="input-group mb-3">
                          ...
                          <select name="form_as02_reresep05_01" class="form-control form-control-sm">
                      <?PHP 
                            $cpf_form_no_reresep05 = 0;
                            while($cpf_form_no_reresep05<= 4){
                              if($cpf_vcform01_sww['form_as02_reresep05_01']==$cpf_form_no_reresep05){
                              echo"<option value=$cpf_form_no_reresep05 selected>$cpf_form_no_reresep05</option>";	
                              }else{
                              echo"<option value=$cpf_form_no_reresep05>$cpf_form_no_reresep05</option>";	
                              }
                            $cpf_form_no_reresep05++; } 
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_far02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>	
              ...
              <tr>
                ...
                <select name="form_dg_kpr002_01" class="form-control form-control-sm">
                 
                <?PHP 
                    $cpf_form_no_kpr02 = 0;
                    while($cpf_form_no_kpr02<= 3){
                      if($cpf_vcform01_sww['form_dg_kpr002_01']==$cpf_form_no_kpr02){
                ...
                <select name="form_dg_kpr003_01" class="form-control form-control-sm">
                 
                <?PHP 
                    $cpf_form_no_kpr03 = 0;
                    while($cpf_form_no_kpr03<= 3){
                      if($cpf_vcform01_sww['form_dg_kpr003_01']==$cpf_form_no_kpr03){
                      echo"<option value=$cpf_form_no_kpr03 selected>$cpf_form_no_kpr03</option>";	
                      }else{
                      echo"<option value=$cpf_form_no_kpr03>$cpf_form_no_kpr03</option>";	
                      }
                    $cpf_form_no_kpr03++; } 
                ...
                <select name="form_dg_kpr004_01" class="form-control form-control-sm">
                
                <?PHP 
                    $cpf_form_no_kpr04 = 0;
                    while($cpf_form_no_kpr04<= 3){
                      if($cpf_vcform01_sww['form_dg_kpr004_01']==$cpf_form_no_kpr04){
                      echo"<option value=$cpf_form_no_kpr04 selected>$cpf_form_no_kpr04</option>";	
                      }else{
                      echo"<option value=$cpf_form_no_kpr04>$cpf_form_no_kpr04</option>";	
                      }
                    $cpf_form_no_kpr04++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_dg_kpr0202_01" class="form-control form-control-sm">
              <?PHP 
              $cpf_form_no_kpr0202 = 0;
              while($cpf_form_no_kpr0202<= 3){
                if($cpf_vcform01_sww['form_dg_kpr0202_01']==$cpf_form_no_kpr0202){
                echo"<option value=$cpf_form_no_kpr0202 selected>$cpf_form_no_kpr0202</option>";	
                }else{
                echo"<option value=$cpf_form_no_kpr0202>$cpf_form_no_kpr0202</option>";	
                }
              $cpf_form_no_kpr0202++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_dg_kpr0203_01" class="form-control form-control-sm">
                 
                <?PHP 
              $cpf_form_no_kpr0203 = 0;
              while($cpf_form_no_kpr0203<= 3){
                if($cpf_vcform01_sww['form_dg_kpr0203_01']==$cpf_form_no_kpr0203){
                echo"<option value=$cpf_form_no_kpr0203 selected>$cpf_form_no_kpr0203</option>";	
                }else{
                echo"<option value=$cpf_form_no_kpr0203>$cpf_form_no_kpr0203</option>";	
                }
              $cpf_form_no_kpr0203++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_dg_kpr0204_01" class="form-control form-control-sm">
                
                <?PHP 
              $cpf_form_no_kpr0204 = 0;
              while($cpf_form_no_kpr0204<= 3){
                if($cpf_vcform01_sww['form_dg_kpr0204_01']==$cpf_form_no_kpr0204){
                echo"<option value=$cpf_form_no_kpr0204 selected>$cpf_form_no_kpr0204</option>";	
                }else{
                echo"<option value=$cpf_form_no_kpr0204>$cpf_form_no_kpr0204</option>";	
                }
              $cpf_form_no_kpr0204++; } 
               ...
               <div class="input-group mb-3">
                ...
                <select name="form_dg_kpr0205_01" class="form-control form-control-sm">
                
                <?PHP 
              $cpf_form_no_kpr0205 = 0;
              while($cpf_form_no_kpr0205<= 4){
                if($cpf_vcform01_sww['form_dg_kpr0205_01']==$cpf_form_no_kpr0205){
                echo"<option value=$cpf_form_no_kpr0205 selected>$cpf_form_no_kpr0205</option>";	
                }else{
                echo"<option value=$cpf_form_no_kpr0205>$cpf_form_no_kpr0205</option>";	
                }
              $cpf_form_no_kpr0205++; } 
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_dg02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>	
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_dp02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>		
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_et02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>	
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_etgz02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>	
              <tr>
         ...
         <td colspan="3">
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_etkp02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>		
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_etfr02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>	
              <tr>
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_fet_let02_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_fet_let02_01 = 0;
                while($cpf_form_no_fet_let02_01<= 3){
                  if($cpf_vcform01_sww['form_fet_let02_01']==$cpf_form_no_fet_let02_01){
                    echo"<option value=$cpf_form_no_fet_let02_01 selected>$cpf_form_no_fet_let02_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_fet_let02_01>$cpf_form_no_fet_let02_01</option>";	
                  }
                $cpf_form_no_fet_let02_01++; } 
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_fet_let03_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_fet_let03_01 = 0;
                while($cpf_form_no_fet_let03_01<= 3){
                  if($cpf_vcform01_sww['form_fet_let03_01']==$cpf_form_no_fet_let03_01){
                    echo"<option value=$cpf_form_no_fet_let03_01 selected>$cpf_form_no_fet_let03_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_fet_let03_01>$cpf_form_no_fet_let03_01</option>";	
                  }
                $cpf_form_no_fet_let03_01++; } 
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_fet_let04_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_fet_let04_01 = 0;
                while($cpf_form_no_fet_let04_01<= 3){
                  if($cpf_vcform01_sww['form_fet_let04_01']==$cpf_form_no_fet_let04_01){
                    echo"<option value=$cpf_form_no_fet_let04_01 selected>$cpf_form_no_fet_let04_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_fet_let04_01>$cpf_form_no_fet_let04_01</option>";	
                  }
                $cpf_form_no_fet_let04_01++; } 
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_fet02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>		
              <tr>
             ...
             <td colspan="3">
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_trp_ceff02_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_ceff02_01 = 0;
					while($cpf_form_no_trp_ceff02_01<= 3){
						if($cpf_vcform01_sww['form_trp_ceff02_01']==$cpf_form_no_trp_ceff02_01){
							echo"<option value=$cpf_form_no_trp_ceff02_01 selected>$cpf_form_no_trp_ceff02_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_trp_ceff02_01>$cpf_form_no_trp_ceff02_01</option>";	
						}
					$cpf_form_no_trp_ceff02_01++; } 
          ...
          <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                <select name="form_trp_ceff03_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_ceff03_01 = 0;
					while($cpf_form_no_trp_ceff03_01<= 3){
						if($cpf_vcform01_sww['form_trp_ceff03_01']==$cpf_form_no_trp_ceff03_01){
							echo"<option value=$cpf_form_no_trp_ceff03_01 selected>$cpf_form_no_trp_ceff03_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_trp_ceff03_01>$cpf_form_no_trp_ceff03_01</option>";	
						}
					$cpf_form_no_trp_ceff03_01++; } 
           ...
           <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                <select name="form_trp_ceff04_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_ceff04_01 = 0;
					while($cpf_form_no_trp_ceff04_01<= 3){
						if($cpf_vcform01_sww['form_trp_ceff04_01']==$cpf_form_no_trp_ceff04_01){
							echo"<option value=$cpf_form_no_trp_ceff04_01 selected>$cpf_form_no_trp_ceff04_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_trp_ceff04_01>$cpf_form_no_trp_ceff04_01</option>";	
						}
					$cpf_form_no_trp_ceff04_01++; } 
          ...
          <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                <select name="form_trp_ceff05_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_ceff05_01 = 0;
					while($cpf_form_no_trp_ceff05_01<= 4){
						if($cpf_vcform01_sww['form_trp_ceff05_01']==$cpf_form_no_trp_ceff05_01){
							echo"<option value=$cpf_form_no_trp_ceff05_01 selected>$cpf_form_no_trp_ceff05_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_trp_ceff05_01>$cpf_form_no_trp_ceff05_01</option>";	
						}
					$cpf_form_no_trp_ceff05_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_trp_keto02_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_trp_keto02_01 = 0;
                while($cpf_form_no_trp_keto02_01<= 3){
                  if($cpf_vcform01_sww['form_trp_keto02_01']==$cpf_form_no_trp_keto02_01){
                    echo"<option value=$cpf_form_no_trp_keto02_01 selected>$cpf_form_no_trp_keto02_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_trp_keto02_01>$cpf_form_no_trp_keto02_01</option>";	
                  }
                $cpf_form_no_trp_keto02_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_trp_keto03_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_trp_keto03_01 = 0;
                while($cpf_form_no_trp_keto03_01<= 3){
                  if($cpf_vcform01_sww['form_trp_keto03_01']==$cpf_form_no_trp_keto03_01){
                    echo"<option value=$cpf_form_no_trp_keto03_01 selected>$cpf_form_no_trp_keto03_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_trp_keto03_01>$cpf_form_no_trp_keto03_01</option>";	
                  }
                $cpf_form_no_trp_keto03_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_trp_keto04_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_trp_keto04_01 = 0;
                while($cpf_form_no_trp_keto04_01<= 3){
                  if($cpf_vcform01_sww['form_trp_keto04_01']==$cpf_form_no_trp_keto04_01){
                    echo"<option value=$cpf_form_no_trp_keto04_01 selected>$cpf_form_no_trp_keto04_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_trp_keto04_01>$cpf_form_no_trp_keto04_01</option>";	
                  }
                $cpf_form_no_trp_keto04_01++; } 
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_trp_rt02_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_rt02_01 = 0;
					while($cpf_form_no_trp_rt02_01<= 3){
						if($cpf_vcform01_sww['form_trp_rt02_01']==$cpf_form_no_trp_rt02_01){
							echo"<option value=$cpf_form_no_trp_rt02_01 selected>$cpf_form_no_trp_rt02_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_trp_rt02_01>$cpf_form_no_trp_rt02_01</option>";	
						}
					$cpf_form_no_trp_rt02_01++; } 
          ...
          <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                <select name="form_trp_rt03_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_rt03_01 = 0;
					while($cpf_form_no_trp_rt03_01<= 3){
						if($cpf_vcform01_sww['form_trp_rt03_01']==$cpf_form_no_trp_rt03_01){
							echo"<option value=$cpf_form_no_trp_rt03_01 selected>$cpf_form_no_trp_rt03_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_trp_rt03_01>$cpf_form_no_trp_rt03_01</option>";	
						}
					$cpf_form_no_trp_rt03_01++; } 
          ...
          <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                <select name="form_trp_rt04_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_rt04_01 = 0;
					while($cpf_form_no_trp_rt04_01<= 3){
						if($cpf_vcform01_sww['form_trp_rt04_01']==$cpf_form_no_trp_rt04_01){
							echo"<option value=$cpf_form_no_trp_rt04_01 selected>$cpf_form_no_trp_rt04_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_trp_rt04_01>$cpf_form_no_trp_rt04_01</option>";	
						}
					$cpf_form_no_trp_rt04_01++; } 
           ...
           <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                <select name="form_trp_rt05_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_rt05_01 = 0;
					while($cpf_form_no_trp_rt05_01 <= 4){
						if($cpf_vcform01_sww['form_trp_rt05_01']==$cpf_form_no_trp_rt05_01){
							echo"<option value=$cpf_form_no_trp_rt05_01 selected>$cpf_form_no_trp_rt05_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_trp_rt05_01>$cpf_form_no_trp_rt05_01</option>";	
						}
					$cpf_form_no_trp_rt05_01++; } 
          ...
          <!-- -->
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_trp02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>	
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_trp_rl02_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_trp_rl02_01 = 0;
                while($cpf_form_no_trp_rl02_01<= 3){
                  if($cpf_vcform01_sww['form_trp_rl02_01']==$cpf_form_no_trp_rl02_01){
                    echo"<option value=$cpf_form_no_trp_rl02_01 selected>$cpf_form_no_trp_rl02_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_trp_rl02_01>$cpf_form_no_trp_rl02_01</option>";	
                  }
                $cpf_form_no_trp_rl02_01++; } 
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_trp_rl03_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_trp_rl03_01 = 0;
                while($cpf_form_no_trp_rl03_01<= 3){
                  if($cpf_vcform01_sww['form_trp_rl03_01']==$cpf_form_no_trp_rl03_01){
                    echo"<option value=$cpf_form_no_trp_rl03_01 selected>$cpf_form_no_trp_rl03_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_trp_rl03_01>$cpf_form_no_trp_rl03_01</option>";	
                  }
                $cpf_form_no_trp_rl03_01++; } 
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_trp_rl04_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_trp_rl04_01 = 0;
                while($cpf_form_no_trp_rl04_01<= 3){
                  if($cpf_vcform01_sww['form_trp_rl04_01']==$cpf_form_no_trp_rl04_01){
                    echo"<option value=$cpf_form_no_trp_rl04_01 selected>$cpf_form_no_trp_rl04_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_trp_rl04_01>$cpf_form_no_trp_rl04_01</option>";	
                  }
                $cpf_form_no_trp_rl04_01++; } 
                ...
                <?PHP 
					...
					while($cpf_form_no_trp_met_01<= 3){
						if($cpf_vcform01_sww['form_trp_met_01']==$cpf_form_no_trp_met_01){
							...
							echo"<option value=$cpf_form_no_met_01>$cpf_form_no_trp_met_01</option>";	
						}
              ...
              <tr>
                <td height="21">&nbsp;</td>
                <td>Metronidazole inf 3 x 500mg</td>
                <td colspan="3">
                  <!-- -->
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                ...
                <select name="form_trp_mett02_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_mett02_01 = 0;
					while($cpf_form_no_trp_mett02_01<= 3){
						if($cpf_vcform01_sww['form_trp_mett02_01']==$cpf_form_no_trp_mett02_01){
							echo"<option value=$cpf_form_no_trp_mett02_01 selected>$cpf_form_no_trp_mett02_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_mett02_01>$cpf_form_no_trp_mett02_01</option>";	
						}
					$cpf_form_no_trp_mett02_01++; } 
             ...
             <div class="input-group mb-3">
                ...
                <select name="form_trp_mett03_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_mett03_01 = 0;
					while($cpf_form_no_trp_mett03_01<= 3){
						if($cpf_vcform01_sww['form_trp_mett03_01']==$cpf_form_no_trp_mett03_01){
							echo"<option value=$cpf_form_no_trp_mett03_01 selected>$cpf_form_no_trp_mett03_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_mett03_01>$cpf_form_no_trp_mett03_01</option>";	
						}
					$cpf_form_no_trp_mett03_01++; } 
            ...
            <div class="input-group mb-3">
                ...
                <select name="form_trp_mett04_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_mett04_01 = 0;
					while($cpf_form_no_trp_mett04_01<= 3){
						if($cpf_vcform01_sww['form_trp_mett04_01']==$cpf_form_no_trp_mett04_01){
							echo"<option value=$cpf_form_no_trp_mett04_01 selected>$cpf_form_no_trp_mett04_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_mett04_01>$cpf_form_no_trp_mett04_01</option>";	
						}
					$cpf_form_no_trp_mett04_01++; } 
           ...
           <div class="input-group mb-3">
                ...
                <select name="form_trp_mett05_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_trp_mett05_01 = 0;
					while($cpf_form_no_trp_mett05_01<= 4){
						if($cpf_vcform01_sww['form_trp_mett05_01']==$cpf_form_no_trp_mett05_01){
							echo"<option value=$cpf_form_no_trp_mett05_01 selected>$cpf_form_no_trp_mett05_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_mett05_01>$cpf_form_no_trp_mett05_01</option>";	
						}
					$cpf_form_no_trp_mett05_01++; } 
            ...
            $cpf_form_no_trp_ran_01++; } 
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_trpin02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>	
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_trpan02_vform01_sw)."%</span>" ?> 
                  <!-- -->
                </td>
                <td>-</td>
              </tr>
             ...
             <td align="center">&nbsp;</td>
              ...
              <tr>
                ...
                <select name="form_int_nic1402_01" class="form-control form-control-sm">
                <?PHP 
                  $cpf_form_no_int_nic1402_01 = 0;
                  while($cpf_form_no_int_nic1402_01<= 3){
                    if($cpf_vcform01_sww['form_int_nic1402_01']==$cpf_form_no_int_nic1402_01){
                      echo"<option value=$cpf_form_no_int_nic1402_01 selected>$cpf_form_no_int_nic1402_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_int_nic1402_01>$cpf_form_no_int_nic1402_01</option>";	
                    }
                  $cpf_form_no_int_nic1402_01++; } 
                ...
                <select name="form_int_nic1403_01" class="form-control form-control-sm">
                <?PHP 
                  $cpf_form_no_int_nic1403_01 = 0;
                  while($cpf_form_no_int_nic1403_01<= 3){
                    if($cpf_vcform01_sww['form_int_nic1403_01']==$cpf_form_no_int_nic1403_01){
                      echo"<option value=$cpf_form_no_int_nic1403_01 selected>$cpf_form_no_int_nic1403_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_int_nic1403_01>$cpf_form_no_int_nic1403_01</option>";	
                    }
                  $cpf_form_no_int_nic1403_01++; } 
                ...
                <select name="form_int_nic1404_01" class="form-control form-control-sm">
                <?PHP 
                  $cpf_form_no_int_nic1404_01 = 0;
                  while($cpf_form_no_int_nic1404_01<= 3){
                    if($cpf_vcform01_sww['form_int_nic1404_01']==$cpf_form_no_int_nic1404_01){
                      echo"<option value=$cpf_form_no_int_nic1404_01 selected>$cpf_form_no_int_nic1404_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_int_nic1404_01>$cpf_form_no_int_nic1404_01</option>";	
                    }
                  $cpf_form_no_int_nic1404_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_int_nic6502_01" class="form-control form-control-sm">
                
                <?PHP 
					$cpf_form_no_int_nic6502_01 = 0;
					while($cpf_form_no_int_nic6502_01<= 3){
						if($cpf_vcform01_sww['form_int_nic6502_01']==$cpf_form_no_int_nic6502_01){
							echo"<option value=$cpf_form_no_int_nic6502_01 selected>$cpf_form_no_int_nic6502_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_int_nic6502_01>$cpf_form_no_int_nic6502_01</option>";	
						}
					$cpf_form_no_int_nic6502_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_int_nic6503_01" class="form-control form-control-sm">
                
                <?PHP 
					$cpf_form_no_int_nic6503_01 = 0;
					while($cpf_form_no_int_nic6503_01<= 3){
						if($cpf_vcform01_sww['form_int_nic6503_01']==$cpf_form_no_int_nic6503_01){
							echo"<option value=$cpf_form_no_int_nic6503_01 selected>$cpf_form_no_int_nic6503_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_int_nic6503_01>$cpf_form_no_int_nic6503_01</option>";	
						}
					$cpf_form_no_int_nic6503_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_int_nic6504_01" class="form-control form-control-sm">
               
                <?PHP 
					$cpf_form_no_int_nic6504_01 = 0;
					while($cpf_form_no_int_nic6504_01<= 3){
						if($cpf_vcform01_sww['form_int_nic6504_01']==$cpf_form_no_int_nic6504_01){
							echo"<option value=$cpf_form_no_int_nic6504_01 selected>$cpf_form_no_int_nic6504_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_int_nic6504_01>$cpf_form_no_int_nic6504_01</option>";	
						}
					$cpf_form_no_int_nic6504_01++; } 
              ...
              <tr>
                ...
                <select name="form_int_nic23102_01" class="form-control form-control-sm">
            <?PHP 
					$cpf_form_no_int_nic23102_01 = 0;
					while($cpf_form_no_int_nic23102_01<= 3){
						if($cpf_vcform01_sww['form_int_nic23102_01']==$cpf_form_no_int_nic23102_01){
							echo"<option value=$cpf_form_no_int_nic23102_01 selected>$cpf_form_no_int_nic23102_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_int_nic23102_01>$cpf_form_no_int_nic23102_01</option>";	
						}
					$cpf_form_no_int_nic23102_01++; } 
           ...
           <div class="input-group mb-3">
                ...
                <select name="form_int_nic23103_01" class="form-control form-control-sm">
            <?PHP 
					$cpf_form_no_int_nic23103_01 = 0;
					while($cpf_form_no_int_nic23103_01<= 3){
						if($cpf_vcform01_sww['form_int_nic23103_01']==$cpf_form_no_int_nic23103_01){
							echo"<option value=$cpf_form_no_int_nic23103_01 selected>$cpf_form_no_int_nic23103_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_int_nic23103_01>$cpf_form_no_int_nic23103_01</option>";	
						}
					$cpf_form_no_int_nic23103_01++; } 
          ...
          <div class="input-group mb-3">
                ...
                <select name="form_int_nic23104_01" class="form-control form-control-sm">
            <?PHP 
					$cpf_form_no_int_nic23104_01 = 0;
					while($cpf_form_no_int_nic23104_01<= 3){
						if($cpf_vcform01_sww['form_int_nic23104_01']==$cpf_form_no_int_nic23104_01){
							echo"<option value=$cpf_form_no_int_nic23104_01 selected>$cpf_form_no_int_nic23104_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_int_nic23104_01>$cpf_form_no_int_nic23104_01</option>";	
						}
					$cpf_form_no_int_nic23104_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_int_nic23002_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_int_nic23002_01 = 0;
                while($cpf_form_no_int_nic23002_01<= 3){
                  if($cpf_vcform01_sww['form_int_nic23002_01']==$cpf_form_no_int_nic23002_01){
                    echo"<option value=$cpf_form_no_int_nic23002_01 selected>$cpf_form_no_int_nic23002_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_int_nic23002_01>$cpf_form_no_int_nic23002_01</option>";	
                  }
                $cpf_form_no_int_nic23002_01++; } 
           ...
           <div class="input-group mb-3">
                ...
                <select name="form_int_nic23003_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_int_nic23003_01 = 0;
                while($cpf_form_no_int_nic23003_01<= 3){
                  if($cpf_vcform01_sww['form_int_nic23003_01']==$cpf_form_no_int_nic23003_01){
                    echo"<option value=$cpf_form_no_int_nic23003_01 selected>$cpf_form_no_int_nic23003_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_int_nic23003_01>$cpf_form_no_int_nic23003_01</option>";	
                  }
                $cpf_form_no_int_nic23003_01++; } 
          ...
          <div class="input-group mb-3">
                ...
                <select name="form_int_nic23004_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_int_nic23004_01 = 0;
                while($cpf_form_no_int_nic23004_01<= 3){
                  if($cpf_vcform01_sww['form_int_nic23004_01']==$cpf_form_no_int_nic23004_01){
                    echo"<option value=$cpf_form_no_int_nic23004_01 selected>$cpf_form_no_int_nic23004_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_int_nic23004_01>$cpf_form_no_int_nic23004_01</option>";	
                  }
                $cpf_form_no_int_nic23004_01++; } 
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"> <?PHP echo "<span class='badge bg-warning'>".ceil($cpf_int02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>	
              <tr>
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_int_tetp02_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_int_tetp02_01 = 0;
                while($cpf_form_no_int_tetp02_01<= 3){
                  if($cpf_vcform01_sww['form_int_tetp02_01']==$cpf_form_no_int_tetp02_01){
                    echo"<option value=$cpf_form_no_int_tetp02_01 selected>$cpf_form_no_int_tetp02_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_int_tetp02_01>$cpf_form_no_int_tetp02_01</option>";	
                  }
                $cpf_form_no_int_tetp02_01++; } 
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_int_tetp03_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_int_tetp03_01 = 0;
                while($cpf_form_no_int_tetp03_01<= 3){
                  if($cpf_vcform01_sww['form_int_tetp03_01']==$cpf_form_no_int_tetp03_01){
                    echo"<option value=$cpf_form_no_int_tetp03_01 selected>$cpf_form_no_int_tetp03_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_int_tetp03_01>$cpf_form_no_int_tetp03_01</option>";	
                  }
                $cpf_form_no_int_tetp03_01++; } 
            ...
            <div class="input-group mb-3">
                ...
                <select name="form_int_tetp04_01" class="form-control form-control-sm">
                <?PHP 
                $cpf_form_no_int_tetp04_01 = 0;
                while($cpf_form_no_int_tetp04_01<= 3){
                  if($cpf_vcform01_sww['form_int_tetp04_01']==$cpf_form_no_int_tetp04_01){
                    echo"<option value=$cpf_form_no_int_tetp04_01 selected>$cpf_form_no_int_tetp04_01</option>";	
                  }else{
                    echo"<option value=$cpf_form_no_int_tetp04_01>$cpf_form_no_int_tetp04_01</option>";	
                  }
                $cpf_form_no_int_tetp04_01++; } 
              ...
              <tr>
                ...
                <select name="form_int_obatmayor02_01" class="form-control form-control-sm">
              <?PHP 
              $cpf_form_no_int_obatmayor02_01 = 0;
              while($cpf_form_no_int_obatmayor02_01<= 3){
                if($cpf_vcform01_sww['form_int_obatmayor02_01']==$cpf_form_no_int_obatmayor02_01){
                  echo"<option value=$cpf_form_no_int_obatmayor02_01 selected>$cpf_form_no_int_obatmayor02_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_int_obatmayor02_01>$cpf_form_no_int_obatmayor02_01</option>";	
                }
              $cpf_form_no_int_obatmayor02_01++; } 
               ...
               <div class="input-group mb-3">
                ...
                <select name="form_int_obatmayor03_01" class="form-control form-control-sm">
              <?PHP 
              $cpf_form_no_int_obatmayor03_01 = 0;
              while($cpf_form_no_int_obatmayor03_01<= 3){
                if($cpf_vcform01_sww['form_int_obatmayor03_01']==$cpf_form_no_int_obatmayor03_01){
                  echo"<option value=$cpf_form_no_int_obatmayor03_01 selected>$cpf_form_no_int_obatmayor03_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_int_obatmayor03_01>$cpf_form_no_int_obatmayor03_01</option>";	
                }
              $cpf_form_no_int_obatmayor03_01++; } 
            ...
            <!-- -->
               <div class="input-group mb-3">
                ...
                <select name="form_int_obatmayor04_01" class="form-control form-control-sm">
              <?PHP 
              $cpf_form_no_int_obatmayor04_01 = 0;
              while($cpf_form_no_int_obatmayor04_01<= 3){
                if($cpf_vcform01_sww['form_int_obatmayor04_01']==$cpf_form_no_int_obatmayor04_01){
                  echo"<option value=$cpf_form_no_int_obatmayor04_01 selected>$cpf_form_no_int_obatmayor04_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_int_obatmayor04_01>$cpf_form_no_int_obatmayor04_01</option>";	
                }
              $cpf_form_no_int_obatmayor04_01++; } 
              ...
              <tr>
                ...
                <td>-</td>
                <td colspan="3">
                <?PHP echo "<span class='badge bg-warning'>".ceil($cpf_intgz02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>	
              <tr>
              ...
              <tr>
                ...
                <select name="form_mon_rev02_01" class="form-control form-control-sm">
                <?PHP 
                  $cpf_form_no_mon_rev02_01 = 0;
                  while($cpf_form_no_mon_rev02_01<= 3){
                    if($cpf_vcform01_sww['form_mon_rev02_01']==$cpf_form_no_mon_rev02_01){
                      echo"<option value=$cpf_form_no_mon_rev02_01 selected>$cpf_form_no_mon_rev02_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_mon_rev02_01>$cpf_form_no_mon_rev02_01</option>";	
                    }
                  $cpf_form_no_mon_rev02_01++; } 
                ...
                <select name="form_mon_rev03_01" class="form-control form-control-sm">
                <?PHP 
                  $cpf_form_no_mon_rev03_01 = 0;
                  while($cpf_form_no_mon_rev03_01<= 3){
                    if($cpf_vcform01_sww['form_mon_rev03_01']==$cpf_form_no_mon_rev03_01){
                      echo"<option value=$cpf_form_no_mon_rev03_01 selected>$cpf_form_no_mon_rev03_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_mon_rev03_01>$cpf_form_no_mon_rev03_01</option>";	
                    }
                  $cpf_form_no_mon_rev03_01++; } 
          ...
          <div class="input-group mb-3">
                ...
                <select name="form_mon_rev04_01" class="form-control form-control-sm">
                <?PHP 
                  $cpf_form_no_mon_rev04_01 = 0;
                  while($cpf_form_no_mon_rev04_01<= 3){
                    if($cpf_vcform01_sww['form_mon_rev04_01']==$cpf_form_no_mon_rev04_01){
                      echo"<option value=$cpf_form_no_mon_rev04_01 selected>$cpf_form_no_mon_rev04_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_mon_rev04_01>$cpf_form_no_mon_rev04_01</option>";
                    
                    }
                  $cpf_form_no_mon_rev04_01++; } 
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_dpjp02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>	
              <tr>
                ...
                <select name="form_mon_skala02_01" class="form-control form-control-sm">
                <?PHP 
                  $cpf_form_no_mon_skala02_01 = 0;
                  while($cpf_form_no_mon_skala02_01<= 3){
                    if($cpf_vcform01_sww['form_mon_skala02_01']==$cpf_form_no_mon_skala02_01){
                      echo"<option value=$cpf_form_no_mon_skala02_01 selected>$cpf_form_no_mon_skala02_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_mon_skala02_01>$cpf_form_no_mon_skala02_01</option>";	
                    }
                  $cpf_form_no_mon_skala02_01++; } 
                ...
                <select name="form_mon_skala03_01" class="form-control form-control-sm">
                <?PHP 
                  $cpf_form_no_mon_skala03_01 = 0;
                  while($cpf_form_no_mon_skala03_01<= 3){
                    if($cpf_vcform01_sww['form_mon_skala03_01']==$cpf_form_no_mon_skala03_01){
                      echo"<option value=$cpf_form_no_mon_skala03_01 selected>$cpf_form_no_mon_skala03_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_mon_skala03_01>$cpf_form_no_mon_skala03_01</option>";	
                    }
                  $cpf_form_no_mon_skala03_01++; } 
                ...
                <select name="form_mon_skala04_01" class="form-control form-control-sm">
                <?PHP 
                  $cpf_form_no_mon_skala04_01 = 0;
                  while($cpf_form_no_mon_skala04_01<= 3){
                    if($cpf_vcform01_sww['form_mon_skala04_01']==$cpf_form_no_mon_skala04_01){
                      echo"<option value=$cpf_form_no_mon_skala04_01 selected>$cpf_form_no_mon_skala04_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_mon_skala04_01>$cpf_form_no_mon_skala04_01</option>";	
                    }
                  $cpf_form_no_mon_skala04_01++; } 
              ...
              <tr>
               ...
               <div class="input-group mb-3">
                ...
                <select name="form_mon_imp02_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_imp02_01 = 0;
              while($cpf_form_no_mon_imp02_01<= 3){
                if($cpf_vcform01_sww['form_mon_imp02_01']==$cpf_form_no_mon_imp02_01){
                  echo"<option value=$cpf_form_no_mon_imp02_01 selected>$cpf_form_no_mon_imp02_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_imp02_01>$cpf_form_no_mon_imp02_01</option>";	
                }
              $cpf_form_no_mon_imp02_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_mon_imp03_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_imp03_01 = 0;
              while($cpf_form_no_mon_imp03_01<= 3){
                if($cpf_vcform01_sww['form_mon_imp03_01']==$cpf_form_no_mon_imp03_01){
                  echo"<option value=$cpf_form_no_mon_imp03_01 selected>$cpf_form_no_mon_imp03_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_imp03_01>$cpf_form_no_mon_imp03_01</option>";	
                }
              $cpf_form_no_mon_imp03_01++; } 
                ...
                <select name="form_mon_imp04_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_imp04_01 = 0;
              while($cpf_form_no_mon_imp04_01<= 3){
                if($cpf_vcform01_sww['form_mon_imp03_01']==$cpf_form_no_mon_imp04_01){
                  echo"<option value=$cpf_form_no_mon_imp04_01 selected>$cpf_form_no_mon_imp04_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_imp04_01>$cpf_form_no_mon_imp04_01</option>";	
                }
              $cpf_form_no_mon_imp04_01++; } 
              ...
              <tr>
               ...
               <td colspan="3">
                ...
                <select name="form_mon_tanda02_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_tanda02_01 = 0;
              while($cpf_form_no_mon_tanda02_01<= 3){
                if($cpf_vcform01_sww['form_mon_tanda02_01']==$cpf_form_no_mon_tanda02_01){
                  echo"<option value=$cpf_form_no_mon_tanda02_01 selected>$cpf_form_no_mon_tanda02_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_tanda02_01>$cpf_form_no_mon_tanda02_01</option>";	
                }
              $cpf_form_no_mon_tanda02_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_mon_tanda03_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_tanda03_01 = 0;
              while($cpf_form_no_mon_tanda03_01<= 3){
                if($cpf_vcform01_sww['form_mon_tanda03_01']==$cpf_form_no_mon_tanda03_01){
                  echo"<option value=$cpf_form_no_mon_tanda03_01 selected>$cpf_form_no_mon_tanda03_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_tanda03_01>$cpf_form_no_mon_tanda03_01</option>";	
                }
              $cpf_form_no_mon_tanda03_01++; } 
              ...
              <div class="input-group mb-3">
                ...
                <select name="form_mon_tanda04_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_tanda04_01 = 0;
              while($cpf_form_no_mon_tanda04_01<= 3){
                if($cpf_vcform01_sww['form_mon_tanda04_01']==$cpf_form_no_mon_tanda04_01){
                  echo"<option value=$cpf_form_no_mon_tanda04_01 selected>$cpf_form_no_mon_tanda04_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_tanda04_01>$cpf_form_no_mon_tanda04_01</option>";	
                }
              $cpf_form_no_mon_tanda04_01++; } 
              ...
              <tr>
               ...
               <td colspan="3">
                ...
                <select name="form_mon_pro02_01" class="form-control form-control-sm">
                        <?PHP 
                  $cpf_form_no_mon_pro02_01 = 0;
                  while($cpf_form_no_mon_pro02_01<= 3){
                    if($cpf_vcform01_sww['form_mon_pro02_01']==$cpf_form_no_mon_pro02_01){
                      echo"<option value=$cpf_form_no_mon_pro02_01 selected>$cpf_form_no_mon_pro02_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_mon_pro02_01>$cpf_form_no_mon_pro02_01</option>";	
                    }
                  $cpf_form_no_mon_pro02_01++; } 
                ...
                <select name="form_mon_pro03_01" class="form-control form-control-sm">
                        <?PHP 
                  $cpf_form_no_mon_pro03_01 = 0;
                  while($cpf_form_no_mon_pro03_01<= 3){
                    if($cpf_vcform01_sww['form_mon_pro03_01']==$cpf_form_no_mon_pro03_01){
                      echo"<option value=$cpf_form_no_mon_pro03_01 selected>$cpf_form_no_mon_pro03_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_mon_pro03_01>$cpf_form_no_mon_pro03_01</option>";	
                    }
                  $cpf_form_no_mon_pro03_01++; } 
                ...
                <select name="form_mon_pro04_01" class="form-control form-control-sm">
                        <?PHP 
                  $cpf_form_no_mon_pro04_01 = 0;
                  while($cpf_form_no_mon_pro04_01<= 3){
                    if($cpf_vcform01_sww['form_mon_pro04_01']==$cpf_form_no_mon_pro04_01){
                      echo"<option value=$cpf_form_no_mon_pro04_01 selected>$cpf_form_no_mon_pro04_01</option>";	
                    }else{
                      echo"<option value=$cpf_form_no_mon_pro04_01>$cpf_form_no_mon_pro04_01</option>";	
                    }
                  $cpf_form_no_mon_pro04_01++; } 
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                <select name="form_mon_verbal02_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_verbal02_01 = 0;
              while($cpf_form_no_mon_verbal02_01<= 3){
                if($cpf_vcform01_sww['form_mon_verbal02_01']==$cpf_form_no_mon_verbal02_01){
                  echo"<option value=$cpf_form_no_mon_verbal02_01 selected>$cpf_form_no_mon_verbal02_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_verbal02_01>$cpf_form_no_mon_verbal02_01</option>";	
                }
              $cpf_form_no_mon_verbal02_01++; } 
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                <select name="form_mon_verbal03_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_verbal03_01 = 0;
              while($cpf_form_no_mon_verbal03_01<= 3){
                if($cpf_vcform01_sww['form_mon_verbal03_01']==$cpf_form_no_mon_verbal03_01){
                  echo"<option value=$cpf_form_no_mon_verbal03_01 selected>$cpf_form_no_mon_verbal03_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_verbal03_01>$cpf_form_no_mon_verbal03_01</option>";	
                }
              $cpf_form_no_mon_verbal03_01++; } 
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                <select name="form_mon_verbal04_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_verbal04_01 = 0;
              while($cpf_form_no_mon_verbal04_01<= 3){
                if($cpf_vcform01_sww['form_mon_verbal04_01']==$cpf_form_no_mon_verbal04_01){
                  echo"<option value=$cpf_form_no_mon_verbal04_01 selected>$cpf_form_no_mon_verbal04_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_verbal04_01>$cpf_form_no_mon_verbal04_01</option>";	
                }
              $cpf_form_no_mon_verbal04_01++; } 
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_mon_terapi02_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_terapi02_01 = 0;
              while($cpf_form_no_mon_terapi02_01<= 3){
                if($cpf_vcform01_sww['form_mon_terapi02_01']==$cpf_form_no_mon_terapi02_01){
                  echo"<option value=$cpf_form_no_mon_terapi02_01 selected>$cpf_form_no_mon_terapi02_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_terapi02_01>$cpf_form_no_mon_terapi02_01</option>";	
                }
              $cpf_form_no_mon_terapi02_01++; } 
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_mon_terapi03_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_terapi03_01 = 0;
              while($cpf_form_no_mon_terapi03_01<= 3){
                if($cpf_vcform01_sww['form_mon_terapi03_01']==$cpf_form_no_mon_terapi03_01){
                  echo"<option value=$cpf_form_no_mon_terapi03_01 selected>$cpf_form_no_mon_terapi03_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_terapi03_01>$cpf_form_no_mon_terapi03_01</option>";	
                }
              $cpf_form_no_mon_terapi03_01++; } 
              ...
              <div class="input-group-prepend">
                ...
                <select name="form_mon_terapi04_01" class="form-control form-control-sm">
                <?PHP 
              $cpf_form_no_mon_terapi04_01 = 0;
              while($cpf_form_no_mon_terapi04_01<= 3){
                if($cpf_vcform01_sww['form_mon_terapi04_01']==$cpf_form_no_mon_terapi04_01){
                  echo"<option value=$cpf_form_no_mon_terapi04_01 selected>$cpf_form_no_mon_terapi04_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_terapi04_01>$cpf_form_no_mon_terapi04_01</option>";	
                }
              $cpf_form_no_mon_terapi04_01++; } 
              ...
              <tr>
                ...
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1">DAY 1</span>
                    ...
                    <select name="form_mon_cairan02_01" class="form-control form-control-sm">
                    <?PHP 
              $cpf_form_no_mon_cairan02_01 = 0;
              while($cpf_form_no_mon_cairan02_01<= 3){
                if($cpf_vcform01_sww['form_mon_cairan02_01']==$cpf_form_no_mon_cairan02_01){
                  echo"<option value=$cpf_form_no_mon_cairan02_01 selected>$cpf_form_no_mon_cairan02_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_cairan02_01>$cpf_form_no_mon_cairan02_01</option>";	
                }
              $cpf_form_no_mon_cairan02_01++; } 
                ...
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1">DAy 2</span>
                    ...
                    <select name="form_mon_cairan03_01" class="form-control form-control-sm">
                    <?PHP 
              $cpf_form_no_mon_cairan03_01 = 0;
              while($cpf_form_no_mon_cairan03_01<= 3){
                if($cpf_vcform01_sww['form_mon_cairan03_01']==$cpf_form_no_mon_cairan03_01){
                  echo"<option value=$cpf_form_no_mon_cairan03_01 selected>$cpf_form_no_mon_cairan03_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_cairan03_01>$cpf_form_no_mon_cairan03_01</option>";	
                }
              $cpf_form_no_mon_cairan03_01++; } 
                ...
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1">DAY 3</span>
                    ...
                    <select name="form_mon_cairan04_01" class="form-control form-control-sm">
                    <?PHP 
              $cpf_form_no_mon_cairan04_01 = 0;
              while($cpf_form_no_mon_cairan04_01<= 3){
                if($cpf_vcform01_sww['form_mon_cairan04_01']==$cpf_form_no_mon_cairan04_01){
                  echo"<option value=$cpf_form_no_mon_cairan04_01 selected>$cpf_form_no_mon_cairan04_01</option>";	
                }else{
                  echo"<option value=$cpf_form_no_mon_cairan04_01>$cpf_form_no_mon_cairan04_01</option>";	
                }
              $cpf_form_no_mon_cairan04_01++; } 
              ...
              <tr>
                ...
                <select name="form_mon_infeksi02_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_mon_infeksi02_01 = 0;
					while($cpf_form_no_mon_infeksi02_01<= 3){
						if($cpf_vcform01_sww['form_mon_infeksi02_01']==$cpf_form_no_mon_infeksi02_01){
							echo"<option value=$cpf_form_no_mon_infeksi02_01 selected>$cpf_form_no_mon_infeksi02_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_mon_infeksi02_01>$cpf_form_no_mon_infeksi02_01</option>";	
						}
					$cpf_form_no_mon_infeksi02_01++; } 
          ...
          <div class="input-group mb-3">
                ...
                <select name="form_mon_infeksi03_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_mon_infeksi03_01 = 0;
					while($cpf_form_no_mon_infeksi03_01<= 3){
						if($cpf_vcform01_sww['form_mon_infeksi03_01']==$cpf_form_no_mon_infeksi03_01){
							echo"<option value=$cpf_form_no_mon_infeksi03_01 selected>$cpf_form_no_mon_infeksi03_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_mon_infeksi03_01>$cpf_form_no_mon_infeksi03_01</option>";	
						}
					$cpf_form_no_mon_infeksi03_01++; } 
          ...
          <div class="input-group mb-3">
                ...
                <select name="form_mon_infeksi04_01" class="form-control form-control-sm">
                <?PHP 
					$cpf_form_no_mon_infeksi04_01 = 0;
					while($cpf_form_no_mon_infeksi04_01<= 3){
						if($cpf_vcform01_sww['form_mon_infeksi04_01']==$cpf_form_no_mon_infeksi04_01){
							echo"<option value=$cpf_form_no_mon_infeksi04_01 selected>$cpf_form_no_mon_infeksi04_01</option>";	
						}else{
							echo"<option value=$cpf_form_no_mon_infeksi04_01>$cpf_form_no_mon_infeksi04_01</option>";	
						}
					$cpf_form_no_mon_infeksi04_01++; } 
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_mon02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>	
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_gz02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_mob02_vform01_sw)."%</span>" ?>
                  <!-- -->
                </td>
                <td>-</td>
              </tr>		
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_otmd02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_otkp02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>	
              <tr>
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_otgz02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>	
              <tr>
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_otrs02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>		
              <tr>
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_kpl02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>	
              <tr>
              ...
              <tr>
                <td>-</td>
                <td>-</td>
                <td colspan="3"><?PHP echo "<span class='badge bg-warning'>".ceil($cpf_rpl02_vform01_sw)."%</span>" ?>
                </td>
                <td>-</td>
              </tr>		
              <tr>
